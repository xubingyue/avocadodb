Executing queries from Avocadosh
===============================

Within the AvocadoDB shell, the *_query* and *_createStatement* methods of the
...
### with _createStatement (AvocadoStatement)

The *_query* method is a shorthand for creating an AvocadoStatement object,
...
#### AvocadoStatement parameters binding
...
This may change in the future. Future versions of AvocadoDB may create result sets incrementally 
