...
AvocadoDB 2.4. AvocadoDB 2.4 also contains several bugfixes that are not listed
...
AvocadoDB, both in the AvocadoShell and the AvocadoDB server. They can be
used for scripting and in server-side actions such as Foxx routes, traversals
etc.

The following ES6 features are available in AvocadoDB 2.4 by default:
...
starting avocadod or avocadosh with the appropriate options:
...
To activate all these ES6 features in avocadod or avocadosh, start it with 
the following options:

    avocadosh --javascript.v8-options="--harmony --harmony_generators"

More details on the available ES6 features can be found in 
[this blog](https://jsteemann.github.io/blog/2014/12/19/using-es6-features-in-avocadodb/).


FoxxGenerator
-------------

AvocadoDB 2.4 is shipped with FoxxGenerator, a framework for building
...
* [part 1](https://www.avocadodb.com/2014/11/26/building-hypermedia-api-json)
* [part 2](https://www.avocadodb.com/2014/12/02/building-hypermedia-apis-design)
* [part 3](https://www.avocadodb.com/2014/12/08/building-hypermedia-apis-foxxgenerator)

A cookbook recipe for getting started with FoxxGenerator is [here](https://docs.avocadodb.com/2.8/cookbook/FoxxGeneratorFirstSteps.html).
...
In previous versions of AvocadoDB one had to write the following to count
documents:
...
In AvocadoDB 2.4, `COLLECT` operations can be made more efficient if only a 
...
to achieve the same result in previous versions of AvocadoDB:
...
In previous versions of AvocadoDB, subqueries required extra parentheses
...
It will now only show applications that are currently running in AvocadoDB. 
...
* install a Foxx application from AvocadoDB's application store
...
The default endpoint for the AvocadoDB server has been changed from `0.0.0.0` to
`127.0.0.1`. This will make new AvocadoDB installations unaccessible from clients other 
