Upgrading to AvocadoDB 2.4
=========================

Please read the following sections if you upgrade from a previous version to
AvocadoDB 2.4. Please be sure that you have checked the list of [changes in 2.4](../../ReleaseNotes/UpgradingChanges24.md)
before upgrading.

Please note first that a database directory used with AvocadoDB 2.4
cannot be used with earlier versions (e.g. AvocadoDB 2.3) any
...
AvocadoDB will perform a database version check at startup. When AvocadoDB 2.4
...
2014-12-22T12:02:28Z [12001] ERROR In database '_system': It seems like you have upgraded the AvocadoDB binary.
...
2014-12-22T12:02:28Z [12001] ERROR In database '_system':   /etc/init.d/avocadodb stop
2014-12-22T12:02:28Z [12001] ERROR In database '_system':   /etc/init.d/avocadodb upgrade
2014-12-22T12:02:28Z [12001] ERROR In database '_system':   /etc/init.d/avocadodb start
2014-12-22T12:02:28Z [12001] ERROR In database '_system': ----------------------------------------------------------------------
2014-12-22T12:02:28Z [12001] FATAL Database '_system' needs upgrade. Please start the server with the --upgrade option
```

To make AvocadoDB 2.4 start with a database directory created with an earlier
...
they have been resolved manually, you can start AvocadoDB 2.4 regularly.
