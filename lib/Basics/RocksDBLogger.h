...
#ifndef AVOCADODB_BASICS_ROCKSDB_LOGGER_H
#define AVOCADODB_BASICS_ROCKSDB_LOGGER_H 1
...
class RocksDBLogger final : public rocksdb::Logger {
 public:
  ...
  // nothing to do here, as AvocadoDB logger infrastructure takes care of flushing itself
  void Flush() override {}
