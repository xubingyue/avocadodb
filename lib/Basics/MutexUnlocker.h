...
#ifndef AVOCADODB_BASICS_MUTEX_UNLOCKER_H
#define AVOCADODB_BASICS_MUTEX_UNLOCKER_H 1
...
#define MUTEX_UNLOCKER(obj, lock) \
  avocadodb::basics::MutexUnlocker<typename std::decay<decltype (lock)>::type> obj(&(lock), __FILE__, __LINE__)
