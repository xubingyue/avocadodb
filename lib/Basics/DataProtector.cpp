...
// template<int Nr>
// thread_local int avocadodb::basics::DataProtector<Nr>::_mySlot = -1;
thread_local int avocadodb::basics::DataProtector::_mySlot = -1;

// TODO: Make this a template again once everybody has gcc >= 4.9.2
// template<int Nr>
// std::atomic<int> avocadodb::basics::DataProtector<Nr>::_last(0);
std::atomic<int> avocadodb::basics::DataProtector::_last(0);
...
// template class avocadodb::basics::DataProtector<64>;

int avocadodb::basics::DataProtector::getMyId() {
  int id = _mySlot;
  if (id >= 0) {
    return id;
  }
