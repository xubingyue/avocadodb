...
rest::ResponseCode GeneralResponse::responseCode(int code) {
  ...
  switch (code) {
    ...
    case TRI_ERROR_AVOCADO_DATABASE_NAME_INVALID:
    case TRI_ERROR_AVOCADO_DOCUMENT_KEY_BAD:
    case TRI_ERROR_AVOCADO_DOCUMENT_KEY_UNEXPECTED:
    case TRI_ERROR_AVOCADO_DOCUMENT_KEY_MISSING:
    ...
    case TRI_ERROR_AVOCADO_INVALID_KEY_GENERATOR:
    case TRI_ERROR_AVOCADO_INVALID_EDGE_ATTRIBUTE:
    case TRI_ERROR_AVOCADO_INDEX_DOCUMENT_ATTRIBUTE_MISSING:
    case TRI_ERROR_AVOCADO_INDEX_CREATION_FAILED:
    case TRI_ERROR_AVOCADO_COLLECTION_TYPE_MISMATCH:
    case TRI_ERROR_AVOCADO_COLLECTION_TYPE_INVALID:
    case TRI_ERROR_AVOCADO_VALIDATION_FAILED:
    case TRI_ERROR_AVOCADO_ATTRIBUTE_PARSER_FAILED:
    case TRI_ERROR_AVOCADO_CROSS_COLLECTION_REQUEST:
    case TRI_ERROR_AVOCADO_INDEX_HANDLE_BAD:
    case TRI_ERROR_AVOCADO_DOCUMENT_TOO_LARGE:
    ...
    case TRI_ERROR_GRAPH_NOT_AN_AVOCADO_COLLECTION:
    ...
    case TRI_ERROR_AVOCADO_USE_SYSTEM_DATABASE:
    case TRI_ERROR_AVOCADO_READ_ONLY:
    case TRI_ERROR_FORBIDDEN:
      return ResponseCode::FORBIDDEN;

    case TRI_ERROR_AVOCADO_DATABASE_NOT_FOUND:
    case TRI_ERROR_AVOCADO_COLLECTION_NOT_FOUND:
    case TRI_ERROR_AVOCADO_VIEW_NOT_FOUND:
    case TRI_ERROR_AVOCADO_COLLECTION_NOT_LOADED:
    case TRI_ERROR_AVOCADO_DOCUMENT_NOT_FOUND:
    case TRI_ERROR_AVOCADO_ENDPOINT_NOT_FOUND:
    case TRI_ERROR_AVOCADO_INDEX_NOT_FOUND:
    ...
    case TRI_ERROR_AVOCADO_DUPLICATE_NAME:
