...
void GeneralServerFeature::collectOptions(
  ...
  options->addOption(
      "--http.hide-product-header",
      "do not expose \"Server: AvocadoDB\" header in HTTP responses",
...
void GeneralServerFeature::defineHandlers() {
  ...
  _handlerFactory->addPrefixHandler(
      "/_api/job", RestHandlerCreator<avocadodb::RestJobHandler>::createData<
                       AsyncJobManager*>,
      _jobManager.get());
  ...
  _handlerFactory->addPrefixHandler(
      "/_admin/job", RestHandlerCreator<avocadodb::RestJobHandler>::createData<
                         AsyncJobManager*>,
      _jobManager.get());
  ...
  _handlerFactory->addPrefixHandler(
      "/_admin/log",
      RestHandlerCreator<avocadodb::RestAdminLogHandler>::createNoData);

  _handlerFactory->addPrefixHandler(
      "/_admin/routing",
      RestHandlerCreator<avocadodb::RestAdminRoutingHandler>::createNoData);
  ...
  _handlerFactory->addPrefixHandler(
      "/_admin/shutdown",
      RestHandlerCreator<avocadodb::RestShutdownHandler>::createNoData);

  if (authentication->isActive()) {
    _handlerFactory->addPrefixHandler(
        "/_open/auth",
        RestHandlerCreator<avocadodb::RestAuthHandler>::createNoData);
  }
