...
class Syncer {
 public:
  ...
  int parseResponse(std::shared_ptr<avocadodb::velocypack::Builder>,
                    avocadodb::httpclient::SimpleHttpResult const*) const;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 protected:
  ...
  TRI_voc_cid_t getCid(avocadodb::velocypack::Slice const&) const;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief extract the collection name from VelocyPack
  //////////////////////////////////////////////////////////////////////////////

  std::string getCName(avocadodb::velocypack::Slice const&) const;

  ///////////////////////////////////////////////////////////////////////////////
  /// @brief extract the collection by either id or name, may return nullptr!
  ////////////////////////////////////////////////////////////////////////////////

  avocadodb::LogicalCollection* getCollectionByIdOrName(TRI_voc_cid_t cid,
  ...
  int createCollection(avocadodb::velocypack::Slice const&,
  ...
  int dropCollection(avocadodb::velocypack::Slice const&, bool);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief creates an index, based on the VelocyPack provided
  //////////////////////////////////////////////////////////////////////////////

  int createIndex(avocadodb::velocypack::Slice const&);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief drops an index, based on the VelocyPack provided
  //////////////////////////////////////////////////////////////////////////////

  int dropIndex(avocadodb::velocypack::Slice const&);
  ...
  int handleStateResponse(avocadodb::velocypack::Slice const&, std::string&);
