...
#ifndef AVOCADOD_REPLICATION_CONTINUOUS_SYNCER_H
#define AVOCADOD_REPLICATION_CONTINUOUS_SYNCER_H 1
...
class ContinuousSyncer : public Syncer {
 ...
 private:
  ...
  bool skipMarker(TRI_voc_tick_t, avocadodb::velocypack::Slice const&) const;
  ...
  int startTransaction(avocadodb::velocypack::Slice const&);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief aborts a transaction, based on the VelocyPack provided
  //////////////////////////////////////////////////////////////////////////////

  int abortTransaction(avocadodb::velocypack::Slice const&);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief commits a transaction, based on the VelocyPack provided
  //////////////////////////////////////////////////////////////////////////////

  int commitTransaction(avocadodb::velocypack::Slice const&);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief process a document operation, based on the VelocyPack provided
  //////////////////////////////////////////////////////////////////////////////

  int processDocument(TRI_replication_operation_e, avocadodb::velocypack::Slice const&,
                      std::string&);
  ...
  int renameCollection(avocadodb::velocypack::Slice const&);
  ...
  int changeCollection(avocadodb::velocypack::Slice const&);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief apply a single marker from the continuous log
  //////////////////////////////////////////////////////////////////////////////

  int applyLogMarker(avocadodb::velocypack::Slice const&, TRI_voc_tick_t, std::string&);
