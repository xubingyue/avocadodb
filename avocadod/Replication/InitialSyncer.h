...
#ifndef AVOCADOD_REPLICATION_INITIAL_SYNCER_H
#define AVOCADOD_REPLICATION_INITIAL_SYNCER_H 1
...
int handleSyncKeysMMFiles(avocadodb::InitialSyncer& syncer,
...
class InitialSyncer : public Syncer {
  friend int ::avocadodb::handleSyncKeysMMFiles(
      avocadodb::InitialSyncer& syncer, avocadodb::LogicalCollection* col,
      std::string const& keysId, std::string const& cid,
      std::string const& collectionName, TRI_voc_tick_t maxTick,
      std::string& errorMsg);

  friend int ::avocadodb::handleSyncKeysRocksDB(
      InitialSyncer& syncer, avocadodb::LogicalCollection* col,
      std::string const& keysId, std::string const& cid,
      std::string const& collectionName, TRI_voc_tick_t maxTick,
      std::string& errorMsg);
 ...
 private:
  ...
  int64_t getSize(avocadodb::LogicalCollection*);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief incrementally fetch data from a collection
  //////////////////////////////////////////////////////////////////////////////

  int handleCollectionDump(avocadodb::LogicalCollection*, std::string const&,
  ...
  int handleCollectionSync(avocadodb::LogicalCollection*, std::string const&,
                           std::string const&, TRI_voc_tick_t, std::string&);
  ...
  int changeCollection(avocadodb::LogicalCollection*,
  ...
  int handleCollection(avocadodb::velocypack::Slice const&,
                       avocadodb::velocypack::Slice const&, bool, std::string&,
                       sync_phase_e);
  ...
  int handleInventoryResponse(avocadodb::velocypack::Slice const&, bool,
                              std::string&);
  ...
  int iterateCollections(
      std::vector<std::pair<avocadodb::velocypack::Slice,
                            avocadodb::velocypack::Slice>> const&,
