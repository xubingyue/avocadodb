...
class Index {
 public:
  ...
  Index(TRI_idx_iid_t, LogicalCollection*, avocadodb::velocypack::Slice const&);

  explicit Index(avocadodb::velocypack::Slice const&);
 ...
 public:
  ...
  inline std::vector<std::vector<avocadodb::basics::AttributeName>> const&
  fields() const {
    return _fields;
  }
  ...
  inline bool isAttributeExpanded(
      std::vector<avocadodb::basics::AttributeName> const& attribute) const {
    for (auto const& it : _fields) {
      if (!avocadodb::basics::AttributeName::namesMatch(attribute, it)) {
        continue;
      }
  ...
  inline bool attributeMatches(
      std::vector<avocadodb::basics::AttributeName> const& attribute) const {
    for (auto const& it : _fields) {
      if (avocadodb::basics::AttributeName::isIdentical(attribute, it, true)) {
        return true;
      }
    }
    return false;
  ...
  virtual bool matchesDefinition(avocadodb::velocypack::Slice const&) const;
  ...
  double selectivityEstimate(
      avocadodb::StringRef const* extra = nullptr) const;
  
  virtual double selectivityEstimateLocal(
      avocadodb::StringRef const* extra) const;
  ...
  virtual void toVelocyPack(avocadodb::velocypack::Builder&, bool withFigures, bool forPersistence) const;
  std::shared_ptr<avocadodb::velocypack::Builder> toVelocyPack(bool withFigures, bool forPersistence) const;

  virtual void toVelocyPackFigures(avocadodb::velocypack::Builder&) const;
  std::shared_ptr<avocadodb::velocypack::Builder> toVelocyPackFigures() const;

  virtual Result insert(transaction::Methods*, TRI_voc_rid_t revisionId,
                     avocadodb::velocypack::Slice const&, bool isRollback) = 0;
  ...
  virtual bool supportsFilterCondition(avocadodb::aql::AstNode const*,
                                       avocadodb::aql::Variable const*, size_t,
                                       size_t&, double&) const;

  virtual bool supportsSortCondition(avocadodb::aql::SortCondition const*,
                                     avocadodb::aql::Variable const*, size_t,
                                     double&, size_t&) const;
  ...
  virtual avocadodb::aql::AstNode* specializeCondition(
      avocadodb::aql::AstNode*, avocadodb::aql::Variable const*) const;

  bool canUseConditionPart(avocadodb::aql::AstNode const* access,
                           avocadodb::aql::AstNode const* other,
                           avocadodb::aql::AstNode const* op,
  ...
  ///        entries.
  virtual void expandInSearchValues(avocadodb::velocypack::Slice const,
                                    avocadodb::velocypack::Builder&) const;

  virtual void warmup(avocadodb::transaction::Methods* trx);
 ...
 protected:
  static size_t sortWeight(avocadodb::aql::AstNode const* node);
 ...
 protected:
  ...
  std::vector<std::vector<avocadodb::basics::AttributeName>> _fields;
...
std::ostream& operator<<(std::ostream&, avocadodb::Index const*);
std::ostream& operator<<(std::ostream&, avocadodb::Index const&);
