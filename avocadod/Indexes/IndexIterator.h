...
class IndexIterator {
 ...
 public:
  ...
  IndexIterator(LogicalCollection*, transaction::Methods*, ManagedDocumentResult*, avocadodb::Index const*);
...
class EmptyIndexIterator final : public IndexIterator {
 public:
  EmptyIndexIterator(LogicalCollection* collection, transaction::Methods* trx, ManagedDocumentResult* mmdr, avocadodb::Index const* index) 
