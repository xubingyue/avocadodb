...
SimpleAttributeEqualityMatcher::SimpleAttributeEqualityMatcher(
    std::vector<std::vector<avocadodb::basics::AttributeName>> const& attributes)
...
bool SimpleAttributeEqualityMatcher::matchOne(
    avocadodb::Index const* index, avocadodb::aql::AstNode const* node,
  ...
  for (size_t i = 0; i < n; ++i) {
    ...
    if (op->type == avocadodb::aql::NODE_TYPE_OPERATOR_BINARY_EQ) {
...
avocadodb::aql::AstNode* SimpleAttributeEqualityMatcher::specializeOne(
    avocadodb::Index const* index, avocadodb::aql::AstNode* node,
...
avocadodb::aql::AstNode* SimpleAttributeEqualityMatcher::specializeAll(
    avocadodb::Index const* index, avocadodb::aql::AstNode* node,
    avocadodb::aql::Variable const* reference) {
...
void SimpleAttributeEqualityMatcher::calculateIndexCosts(
    avocadodb::Index const* index, avocadodb::aql::AstNode const* attribute,
...
bool SimpleAttributeEqualityMatcher::accessFitsIndex(
    avocadodb::Index const* index, avocadodb::aql::AstNode const* access,
    avocadodb::aql::AstNode const* other, avocadodb::aql::AstNode const* op,
    avocadodb::aql::Variable const* reference, 
    std::unordered_set<std::string>& nonNullAttributes,
    bool isExecution) {
  ...
  std::pair<avocadodb::aql::Variable const*,
            std::vector<avocadodb::basics::AttributeName>> attributeData;
