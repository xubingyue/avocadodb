...
#ifndef AVOCADOD_MMFILES_MMFILES_COLLECTOR_CACHE_H
#define AVOCADOD_MMFILES_MMFILES_COLLECTOR_CACHE_H 1
...
struct MMFilesCollectorCache {
  ...
  /// @brief add a ditch
  void addDitch(avocadodb::MMFilesDocumentDitch* ditch) {
  ...
  std::vector<avocadodb::MMFilesDocumentDitch*> ditches;
