...
#ifndef AVOCADOD_MMFILES_MMFILES_EDGE_INDEX_H
#define AVOCADOD_MMFILES_MMFILES_EDGE_INDEX_H 1
...
typedef avocadodb::basics::AssocMulti<avocadodb::velocypack::Slice,
...
class MMFilesEdgeIndexIterator final : public IndexIterator {
 public:
  MMFilesEdgeIndexIterator(LogicalCollection* collection,
                           ...
                           avocadodb::MMFilesEdgeIndex const* index,
...
class MMFilesEdgeIndex final : public Index {
 public:
  ...
  MMFilesEdgeIndex(TRI_idx_iid_t, avocadodb::LogicalCollection*);
 ...
 public:
  ...
  void batchInsert(transaction::Methods*,
                   ...
                   std::shared_ptr<avocadodb::basics::LocalTaskQueue>) override;
 ...
 private:
  ...
  MMFilesSimpleIndexElement buildFromElement(
      TRI_voc_rid_t, avocadodb::velocypack::Slice const& doc) const;
