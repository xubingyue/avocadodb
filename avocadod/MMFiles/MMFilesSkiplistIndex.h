...
class MMFilesBaseSkiplistLookupBuilder {
 protected:
  ...
  avocadodb::velocypack::Slice _lowerSlice;

  transaction::BuilderLeaser _upperBuilder;
  avocadodb::velocypack::Slice _upperSlice;
 ...
 public:
  ...
  avocadodb::velocypack::Slice const* getLowerLookup() const;
  ...
  avocadodb::velocypack::Slice const* getUpperLookup() const;
...
class MMFilesSkiplistLookupBuilder final
 ...
 public:
  MMFilesSkiplistLookupBuilder(
      ...
      std::vector<std::vector<avocadodb::aql::AstNode const*>>&,
      avocadodb::aql::Variable const*, bool);
...
class MMFilesSkiplistIndex final : public MMFilesPathBasedIndex {
 ...
 public:
  ...
  bool supportsSortCondition(avocadodb::aql::SortCondition const*,
                             avocadodb::aql::Variable const*, size_t, double&,
 ...
 private:
  bool isDuplicateOperator(avocadodb::aql::AstNode const*,
                           std::unordered_set<int> const&) const;

  bool accessFitsIndex(
      avocadodb::aql::AstNode const*, avocadodb::aql::AstNode const*,
      avocadodb::aql::AstNode const*, avocadodb::aql::Variable const*,
  ...
  bool findMatchingConditions(
      avocadodb::aql::AstNode const*, avocadodb::aql::Variable const*,
      std::vector<std::vector<avocadodb::aql::AstNode const*>>&, bool&) const;
