...
MMFilesExportCursor::MMFilesExportCursor(TRI_vocbase_t* vocbase, CursorId id,
                           avocadodb::MMFilesCollectionExport* ex, size_t batchSize,
...
void MMFilesExportCursor::dump(VPackBuilder& builder) {
  ...
  try {
    ...
    THROW_AVOCADO_EXCEPTION_MESSAGE(TRI_ERROR_INTERNAL, "internal error during MMFilesExportCursor::dump");
  }
