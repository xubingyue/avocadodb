...
#ifndef AVOCADOD_MMFILES_MMFILES_REVISIONS_CACHE_H
#define AVOCADOD_MMFILES_MMFILES_REVISIONS_CACHE_H 1
...
class MMFilesRevisionsCache {
 ...
 private:
  mutable avocadodb::basics::ReadWriteLock _lock; 
  
  avocadodb::basics::AssocUnique<TRI_voc_rid_t, MMFilesDocumentPosition> _positions;
};
