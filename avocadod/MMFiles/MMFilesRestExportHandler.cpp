...
void MMFilesRestExportHandler::createCursor() {
  ...
  uint64_t waitTime = 0;
  bool flush = avocadodb::basics::VelocyPackHelper::getBooleanValue(
      options, "flush", false);
  ...
  if (flush) {
    ...
    double flushWait =
        avocadodb::basics::VelocyPackHelper::getNumericValue<double>(
  ...
  size_t limit = avocadodb::basics::VelocyPackHelper::getNumericValue<size_t>(
      options, "limit", 0);
