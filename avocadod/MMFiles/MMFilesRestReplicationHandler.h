...
#ifndef AVOCADOD_MMFILES_MMFILES_REST_REPLICATION_HANDLER_H
#define AVOCADOD_MMFILES_MMFILES_REST_REPLICATION_HANDLER_H 1
...
class MMFilesRestReplicationHandler : public RestReplicationHandler {
 ...
 public:
  ...
  static bool sortCollections(avocadodb::LogicalCollection const*,
  ...
  static bool filterCollection(avocadodb::LogicalCollection*, void*);
 ...
 private:
  ...
  int createCollection(VPackSlice, avocadodb::LogicalCollection**, bool);
 ...
 private:
  ...
  static avocadodb::basics::ConditionVariable _condVar;
