...
class MMFilesEngine final : public StorageEngine {
 public:
  ...
  int handleSyncKeys(avocadodb::InitialSyncer& syncer,
  ...
  void getDatabases(avocadodb::velocypack::Builder& result) override;
  ...
  int getViews(TRI_vocbase_t* vocbase,
               avocadodb::velocypack::Builder& result) override;
  ...
  virtual TRI_vocbase_t* openDatabase(
      avocadodb::velocypack::Slice const& parameters, bool isUpgrade,
      int&) override;
  TRI_vocbase_t* createDatabase(TRI_voc_tick_t id,
                                avocadodb::velocypack::Slice const& args,
                                int& status) override {
 ...
 public:
  ...
  std::string createCollection(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                               avocadodb::LogicalCollection const*) override;
  ...
  avocadodb::Result persistCollection(
      TRI_vocbase_t* vocbase, avocadodb::LogicalCollection const*) override;
  ...
  avocadodb::Result dropCollection(TRI_vocbase_t* vocbase,
                                  avocadodb::LogicalCollection*) override;
  ...
  void changeCollection(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                        avocadodb::LogicalCollection const*,
                        bool doSync) override;

  // asks the storage engine to persist renaming of a collection
  // This will write a renameMarker if not in recovery
  avocadodb::Result renameCollection(TRI_vocbase_t* vocbase,
                                    avocadodb::LogicalCollection const*,
  ...
  void createIndex(TRI_vocbase_t* vocbase, TRI_voc_cid_t collectionId,
                   TRI_idx_iid_t id,
                   avocadodb::velocypack::Slice const& data) override;
  ...
  void unloadCollection(TRI_vocbase_t* vocbase,
                        avocadodb::LogicalCollection* collection) override;

  void createView(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                  avocadodb::LogicalView const*) override;

  avocadodb::Result persistView(TRI_vocbase_t* vocbase,
                               avocadodb::LogicalView const*) override;

  avocadodb::Result dropView(TRI_vocbase_t* vocbase,
                            avocadodb::LogicalView*) override;

  void destroyView(TRI_vocbase_t* vocbase, avocadodb::LogicalView*) override;

  void changeView(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                  avocadodb::LogicalView const*, bool doSync) override;

  std::string createViewDirectoryName(std::string const& basePath,
                                      TRI_voc_cid_t id);

  void saveViewInfo(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                    avocadodb::LogicalView const*, bool forceSync) const;
 ...
 private:
  ...
  avocadodb::velocypack::Builder databaseToVelocyPack(TRI_voc_tick_t databaseId,
  ...
  avocadodb::velocypack::Builder loadCollectionInfo(TRI_vocbase_t* vocbase,
                                                   std::string const& path);
  avocadodb::velocypack::Builder loadViewInfo(TRI_vocbase_t* vocbase,
                                             std::string const& path);
 ...
 private:
  ...
  avocadodb::basics::ReadWriteLock mutable _pathsLock;
  ...
  avocadodb::basics::ReadWriteLock mutable _compactionBlockersLock;
