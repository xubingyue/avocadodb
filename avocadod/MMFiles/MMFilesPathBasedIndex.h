...
#ifndef AVOCADOD_MMFILES_PATH_BASED_INDEX_H
#define AVOCADOD_MMFILES_PATH_BASED_INDEX_H 1
...
class MMFilesPathBasedIndex : public Index {
 ...
 public:
  ...
  MMFilesPathBasedIndex(TRI_idx_iid_t, avocadodb::LogicalCollection*,
                 avocadodb::velocypack::Slice const&, size_t baseSize, bool allowPartialIndex);

  ~MMFilesPathBasedIndex();

 public:
  void toVelocyPackFigures(avocadodb::velocypack::Builder&) const override;
 ...
 protected:
  ...
  int fillElement(std::vector<T*>& elements, 
          TRI_voc_rid_t revisionId, avocadodb::velocypack::Slice const&);
