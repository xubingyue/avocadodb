...
#ifndef AVOCADOD_MMFILES_INDEX_ELEMENT_H
#define AVOCADOD_MMFILES_INDEX_ELEMENT_H 1
...
struct MMFilesIndexElementValue {
 ...
 public:
  ...
  /// in place.
  avocadodb::velocypack::Slice slice(IndexLookupContext* context) const;
...
struct MMFilesHashIndexElement {
 ...
 public:
  ...
  avocadodb::velocypack::Slice slice(IndexLookupContext* context, size_t position) const;
  
  static uint64_t hash(avocadodb::velocypack::Slice const& values);
  static uint64_t hash(std::vector<avocadodb::velocypack::Slice> const& values);
  static uint64_t hash(std::vector<std::pair<avocadodb::velocypack::Slice, uint32_t>> const& values);
...
struct MMFilesSimpleIndexElement {
 public:
  ...
  MMFilesSimpleIndexElement(TRI_voc_rid_t revisionId, avocadodb::velocypack::Slice const& value, uint32_t offset); 
  ...
  avocadodb::velocypack::Slice slice(IndexLookupContext*) const;
  ...
  static uint64_t hash(avocadodb::velocypack::Slice const& value);
