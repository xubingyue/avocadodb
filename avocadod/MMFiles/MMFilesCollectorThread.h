...
#ifndef AVOCADOD_MMFILES_COLLECTOR_THREAD_H
#define AVOCADOD_MMFILES_COLLECTOR_THREAD_H 1
...
class MMFilesCollectorThread final : public Thread {
 ...
 private:
  ...
  void processCollectionMarker(
      avocadodb::SingleCollectionTransaction&,
      avocadodb::LogicalCollection*, MMFilesCollectorCache*, MMFilesCollectorOperation const&);
 ...
 private:
  ...
  avocadodb::Mutex _operationsQueueLock;
