...
static std::vector<std::vector<avocadodb::basics::AttributeName>> const
    IndexAttributes{{avocadodb::basics::AttributeName("_from", false)},
                    {avocadodb::basics::AttributeName("_to", false)}};
...
MMFilesEdgeIndexIterator::MMFilesEdgeIndexIterator(
    ...
    ManagedDocumentResult* mmdr, avocadodb::MMFilesEdgeIndex const* index,
...
MMFilesEdgeIndex::MMFilesEdgeIndex(TRI_idx_iid_t iid,
    ...
    : Index(iid, collection,
            std::vector<std::vector<avocadodb::basics::AttributeName>>(
                {{avocadodb::basics::AttributeName(StaticStrings::FromString,
                                                  false)},
                 {avocadodb::basics::AttributeName(StaticStrings::ToString,
                                                  false)}}),
            false, false),
      _edgesFrom(nullptr),
      _edgesTo(nullptr),
...
double MMFilesEdgeIndex::selectivityEstimateLocal(
    avocadodb::StringRef const* attribute) const {
...
avocadodb::aql::AstNode* MMFilesEdgeIndex::specializeCondition(
...
IndexIterator* MMFilesEdgeIndex::createEqIterator(
    transaction::Methods* trx, ManagedDocumentResult* mmdr,
    avocadodb::aql::AstNode const* attrNode,
...
void MMFilesEdgeIndex::handleValNode(
    VPackBuilder* keys, avocadodb::aql::AstNode const* valNode) const {
