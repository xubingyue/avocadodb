...
bool MMFilesRestReplicationHandler::sortCollections(
    avocadodb::LogicalCollection const* l,
    avocadodb::LogicalCollection const* r) {
  if (l->type() != r->type()) {
...
bool MMFilesRestReplicationHandler::filterCollection(
    avocadodb::LogicalCollection* collection, void* data) {
...
void MMFilesRestReplicationHandler::handleCommandLoggerFollow() {
  ...
  if (_request->requestType() == avocadodb::rest::RequestType::PUT) {
...
avocadodb::basics::ConditionVariable MMFilesRestReplicationHandler::_condVar;
