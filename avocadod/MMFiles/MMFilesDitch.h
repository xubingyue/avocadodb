...
#ifndef AVOCADOD_MMFILES_MMFILES_DITCH_H
#define AVOCADOD_MMFILES_MMFILES_DITCH_H 1
...
class MMFilesDropCollectionDitch final : public MMFilesDitch {
 public:
  MMFilesDropCollectionDitch(
      avocadodb::MMFilesDitches* ditches, avocadodb::LogicalCollection* collection,
 ...
 private:
  ...
  std::function<bool(avocadodb::LogicalCollection*)> _callback;
};
