...
#ifndef AVOCADOD_MMFILES_MMFILES_REPLICATION_DUMP_H
#define AVOCADOD_MMFILES_MMFILES_REPLICATION_DUMP_H 1
...
struct MMFilesReplicationDumpContext {
  MMFilesReplicationDumpContext(std::shared_ptr<avocadodb::transaction::StandaloneContext> const&
                             transactionContext,
      ...
      : _transactionContext(transactionContext),
        ...
        _collectionNames(),
        _vpackOptions(avocadodb::velocypack::Options::Defaults),
        _failed(false),
        _bufferFull(false),
        _hasMore(false),
  ...
  std::shared_ptr<avocadodb::transaction::StandaloneContext> _transactionContext;
...
int MMFilesDumpCollectionReplication(MMFilesReplicationDumpContext*,
                                  avocadodb::LogicalCollection*, TRI_voc_tick_t,
                                  TRI_voc_tick_t, bool);
