...
#ifndef AVOCADOD_MMFILES_PERSISTENT_INDEX_H
#define AVOCADOD_MMFILES_PERSISTENT_INDEX_H 1
...
class MMFilesPersistentIndexIterator final : public IndexIterator {
 ...
 public:
  MMFilesPersistentIndexIterator(LogicalCollection* collection,
                                 ...
                                 avocadodb::MMFilesPersistentIndex const* index,
                                 avocadodb::MMFilesPrimaryIndex* primaryIndex,
                                 rocksdb::OptimisticTransactionDB* db,
                                 bool reverse,
                                 avocadodb::velocypack::Slice const& left,
                                 avocadodb::velocypack::Slice const& right);
 ...
 private:
  avocadodb::MMFilesPrimaryIndex* _primaryIndex;
  rocksdb::OptimisticTransactionDB* _db;
  std::unique_ptr<rocksdb::Iterator> _cursor;
  std::unique_ptr<avocadodb::velocypack::Buffer<char>>
