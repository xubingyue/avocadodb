...
#ifndef AVOCADOD_CONSENSUS_STATE_H
#define AVOCADOD_CONSENSUS_STATE_H 1
...
class State {
 public:
  ...
  avocadodb::consensus::index_t log(query_t const& queries, size_t ndups = 0);
  ...
  bool compact(avocadodb::consensus::index_t cind);
  ...
  bool persistCompactionSnapshot(avocadodb::consensus::index_t cind,
                                 avocadodb::consensus::term_t term,
                                 avocadodb::consensus::Store& snapshot);
  ...
  bool restoreLogFromSnapshot(avocadodb::consensus::Store& snapshot,
                              avocadodb::consensus::index_t index,
                              avocadodb::consensus::term_t term);
 ...
 private:
  ...
  bool persist(index_t, term_t, avocadodb::velocypack::Slice const&,
  ...
  bool compactPersisted(avocadodb::consensus::index_t cind);

  /// @brief Compact RAM logs
  bool compactVolatile(avocadodb::consensus::index_t cind);

  /// @brief Remove obsolete logs
  bool removeObsolete(avocadodb::consensus::index_t cind);

  /// @brief Persist read database
  bool persistReadDB(avocadodb::consensus::index_t cind);
