...
#ifndef AVOCADOD_CONSENSUS_STORE_H
#define AVOCADOD_CONSENSUS_STORE_H 1
...
class Store : public avocadodb::Thread {
 public:
  ...
  bool read(avocadodb::velocypack::Slice const&,
  ...
  bool applies(avocadodb::velocypack::Slice const&);
 ...
 private:
  ...
  check_ret_t check(avocadodb::velocypack::Slice const&, CheckMode = FIRST_FAIL) const;
