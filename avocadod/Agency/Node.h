...
class Node {
 public:
  ...
  Node& operator=(avocadodb::velocypack::Slice const&);

  /// @brief Check equality with slice
  bool operator==(avocadodb::velocypack::Slice const&) const;
  ...
  bool applieOp(avocadodb::velocypack::Slice const&);
  ...
  bool handle(avocadodb::velocypack::Slice const&);
