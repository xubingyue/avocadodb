...
#ifndef AVOCADOD_CONSENSUS_AGENT_H
#define AVOCADOD_CONSENSUS_AGENT_H 1
...
class Agent : public avocadodb::Thread,
 ...
 public:
  ...
  void print(avocadodb::LoggerStream&) const;
 ...
 private:
  ...
  avocadodb::basics::ConditionVariable _appendCV;

  /// @brief Condition variable for waitFor
  avocadodb::basics::ConditionVariable _waitForCV;
   ...
   */
  mutable avocadodb::Mutex _ioLock;

  // lock for _leaderCommitIndex
  mutable avocadodb::Mutex _liLock;

  // @brief guard _activator 
  mutable avocadodb::Mutex _activatorLock;
  ...
  avocadodb::Mutex _trxsLock;
 
 public:
  mutable avocadodb::Mutex _compactionLock;
};
}
}
