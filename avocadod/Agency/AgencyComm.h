...
class AgencyCommResultEntry {
 public:
  uint64_t _index;
  std::shared_ptr<avocadodb::velocypack::Builder> _vpack;
  bool _isDir;
};
...
class AgencyPrecondition {
 ...
 public:
  void toVelocyPack(avocadodb::velocypack::Builder& builder) const;
  void toGeneralBuilder(avocadodb::velocypack::Builder& builder) const;
...
public:
  ...
  virtual void toVelocyPack(avocadodb::velocypack::Builder&) const = 0;
...
struct AgencyGeneralTransaction : public AgencyTransaction {
  ...
  void toVelocyPack(
    avocadodb::velocypack::Builder& builder) const override final;
...
class AgencyComm {
 ...
 public:
  ...
  AgencyCommResult setValue(std::string const&,
                            avocadodb::velocypack::Slice const&, double);
  ...
  AgencyCommResult casValue(std::string const&,
                            avocadodb::velocypack::Slice const&, bool, double,
                            double);
  ...
  AgencyCommResult casValue(std::string const&,
                            ...
                            avocadodb::velocypack::Slice const&, double, double);
  ...
  void updateEndpoints(avocadodb::velocypack::Slice const&);
  ...
  AgencyCommResult sendWithFailover(avocadodb::rest::RequestType, double,
 ...
 private:
  ...
  bool unlock(std::string const&, avocadodb::velocypack::Slice const&, double);
