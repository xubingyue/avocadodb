...
#ifndef AVOCADOD_CONSENSUS_SUPERVISION_H
#define AVOCADOD_CONSENSUS_SUPERVISION_H 1
...
class Supervision : public avocadodb::Thread {
 public:
 ...
 private:
  ...
  avocadodb::basics::ConditionVariable _cv; /**< @brief Control if thread
                                              should run */
