...
#ifndef AVOCADOD_CONSENSUS_CONSTITUENT_H
#define AVOCADOD_CONSENSUS_CONSTITUENT_H 1
...
class Constituent : public Thread {
 ...
 private:
  ...
  avocadodb::basics::ConditionVariable _cv;  // agency callbacks
  mutable avocadodb::Mutex _castLock;

  // Keep track of times of last few elections:
  mutable avocadodb::Mutex _recentElectionsMutex;
