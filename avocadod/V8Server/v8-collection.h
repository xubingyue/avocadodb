...
#ifndef AVOCADOD_V8_SERVER_V8_COLLECTION_H
#define AVOCADOD_V8_SERVER_V8_COLLECTION_H 1
...
void ReleaseCollection(avocadodb::LogicalCollection const* collection);

///////////////////////////////////////////////////////////////////////////////
/// @brief check if a name belongs to a collection
////////////////////////////////////////////////////////////////////////////////

bool EqualCollection(avocadodb::CollectionNameResolver const* resolver,
...
v8::Handle<v8::Object> WrapCollection(
    v8::Isolate* isolate, avocadodb::LogicalCollection const* collection);
