...
void TRI_InitV8Users(v8::Handle<v8::Context> context, TRI_vocbase_t* vocbase,
  ...
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoUsers"));
  ...
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoUsersCtor"));
  TRI_AddGlobalFunctionVocbase(isolate, TRI_V8_ASCII_STRING("AvocadoUsersCtor"),
                               ft->GetFunction(), true);

  // register the global object
  v8::Handle<v8::Object> aa = rt->NewInstance();
  if (!aa.IsEmpty()) {
    TRI_AddGlobalVariableVocbase(isolate, TRI_V8_ASCII_STRING("AvocadoUsers"),
                                 aa);
  }
}
