  ...
  if (collectionName.empty()) {
    ...
    if (collection != nullptr) {
      if (!EqualCollection(resolver, collectionName, collection)) {
        return TRI_ERROR_AVOCADO_CROSS_COLLECTION_REQUEST;
      }
    }
  }
...
static void ExistsVocbaseVPack(
  ...
  if (!opResult.successful()) {
    if (opResult.code == TRI_ERROR_AVOCADO_DOCUMENT_NOT_FOUND) {
      TRI_V8_RETURN_FALSE();
    }
...
static void DocumentVocbaseCol(
  ...
  std::string collectionName;
  avocadodb::LogicalCollection const* col
      = TRI_UnwrapClass<avocadodb::LogicalCollection>(args.Holder(), WRP_VOCBASE_COL_TYPE);
  if (col == nullptr) {
    TRI_V8_THROW_EXCEPTION_INTERNAL("cannot extract collection");
  }
  ...
  auto workOnOneDocument = [&](v8::Local<v8::Value> const searchValue, bool isBabies) {
    ...
    if (!ExtractDocumentHandle(isolate, searchValue, collName, searchBuilder,
                               true)) {
      if (!isBabies) {
        THROW_AVOCADO_EXCEPTION(TRI_ERROR_AVOCADO_DOCUMENT_HANDLE_BAD);
      }
    }
...
static void JS_BinaryDocumentVocbaseCol(
  ...
  std::string collectionName;
  avocadodb::LogicalCollection const* col =
      TRI_UnwrapClass<avocadodb::LogicalCollection>(args.Holder(),
    ...
    for (auto const& it : VPackObjectIterator(opResult.slice().resolveExternals())) {
      ...
      if (key == StaticStrings::AttachmentString) {
        ...
        try {
          ...
          TRI_V8_THROW_EXCEPTION_MESSAGE(TRI_ERROR_AVOCADO_DOCUMENT_TYPE_INVALID,
...
static void JS_SetTheLeader(v8::FunctionCallbackInfo<v8::Value> const& args) {
  ...
  if (ServerState::instance()->isDBServer()) {
    avocadodb::LogicalCollection const* v8Collection =
        TRI_UnwrapClass<avocadodb::LogicalCollection>(args.Holder(),
                                                     WRP_VOCBASE_COL_TYPE);
...
static void JS_GetFollowers(v8::FunctionCallbackInfo<v8::Value> const& args) {
  ...
  if (ServerState::instance()->isDBServer()) {
    ...
    std::unique_ptr<avocadodb::FollowerInfo> const& followerInfo = collection->followers();
...
static void JS_PropertiesVocbaseCol(
  ...
  if (ServerState::instance()->isCoordinator()) {
    ...
    if (0 < args.Length()) {
      ...
      if (par->IsObject()) {
        ...
        avocadodb::Result res = info->updateProperties(slice, false);
  ...
  if (isModification) {
    ...
    if (par->IsObject()) {
      ...
      avocadodb::Result updateRes = collection->updateProperties(slice, doSync);
      ...
      avocadodb::Result res2 = physical->persistProperties();
      // TODO Review
...
static int RenameGraphCollections(v8::Isolate* isolate,
  ...
  buffer.appendText("require('@avocadodb/general-graph')._renameCollection(");
...
static void ModifyVocbaseCol(TRI_voc_document_operation_e operation,
  ...
  if (!args[1]->IsObject()) {
    TRI_V8_THROW_EXCEPTION(TRI_ERROR_AVOCADO_DOCUMENT_TYPE_INVALID);
  }
  ...
  auto workOnOneDocument = [&](v8::Local<v8::Value> const newVal) {
    ...
    if (options.isRestore) {
      ...
      if (!obj->HasRealNamedProperty(_RevKey)) {
        THROW_AVOCADO_EXCEPTION(TRI_ERROR_AVOCADO_DOCUMENT_REV_BAD);
      }
    ...
    if (ss->isCoordinator()) {
      try {
        ...
        if (coll->status() == TRI_VOC_COL_STATUS_DELETED || coll->deleted()) {
          TRI_V8_THROW_EXCEPTION_MESSAGE(TRI_ERROR_AVOCADO_COLLECTION_NOT_FOUND, name);
        }
      } catch (...) {
        TRI_V8_THROW_EXCEPTION_MESSAGE(TRI_ERROR_AVOCADO_COLLECTION_NOT_FOUND, name);
      }
...
static int GetRevision(avocadodb::LogicalCollection* collection, TRI_voc_rid_t& rid) {
  TRI_ASSERT(collection != nullptr);
...
static int GetRevisionCoordinator(avocadodb::LogicalCollection* collection,
                                  TRI_voc_rid_t& rid) {
  TRI_ASSERT(collection != nullptr);
...
static avocadodb::LogicalCollection* GetCollectionFromArgument(
...
static void InsertVocbaseCol(v8::Isolate* isolate,
  ...
  auto collection = TRI_UnwrapClass<avocadodb::LogicalCollection>(
...
static void JS_CollectionVocbase(
  ...
  v8::Handle<v8::Value> val = args[0];
  avocadodb::LogicalCollection const* collection = nullptr;
...
// .............................................................................
// generate the avocadodb::LogicalCollection template
// .............................................................................
...
void TRI_InitV8Collections(v8::Handle<v8::Context> context,
  ...
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_changeMode"),
                       JS_ChangeOperationModeVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_collection"),
                       JS_CollectionVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_collections"),
                       JS_CollectionsVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_COMPLETIONS"),
                       JS_CompletionsVocbase, true);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_document"),
                       JS_DocumentVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_exists"),
                       JS_ExistsVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_remove"),
                       JS_RemoveVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_replace"),
                       JS_ReplaceVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_update"),
                       JS_UpdateVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_pregelStart"),
                       JS_PregelStart);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS,
  ...
  // collection object
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("__save"),
                       JS_SaveVocbase, true);
  ...
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoCollection"));
  ...
  TRI_AddGlobalFunctionVocbase(isolate, TRI_V8_ASCII_STRING("AvocadoCollection"),
                               ft->GetFunction());
}
