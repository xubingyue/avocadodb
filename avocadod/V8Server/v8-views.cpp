...
static std::shared_ptr<avocadodb::LogicalView> GetViewFromArgument(
...
v8::Handle<v8::Object> WrapView(v8::Isolate* isolate,
  ...
  if (!result.IsEmpty()) {
    ...
    if (it == v8g->JSViews.end()) {
      ...
      try {
        auto v = new std::shared_ptr<avocadodb::LogicalView>(view);
...
static void JS_DropViewVocbaseObj(
  ...
  std::shared_ptr<avocadodb::LogicalView>* v =
      TRI_UnwrapClass<std::shared_ptr<avocadodb::LogicalView>>(
    ...
    if (par->IsObject()) {
      ...
      bool doSync =
          application_features::ApplicationServer::getFeature<DatabaseFeature>(
              "Database")
              ->forceSyncProperties();
      avocadodb::Result updateRes = view->updateProperties(slice, true, doSync);
...
void TRI_InitV8Views(v8::Handle<v8::Context> context, TRI_vocbase_t* vocbase,
  ...
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_createView"),
                       JS_CreateViewVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_dropView"),
                       JS_DropViewVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_view"),
                       JS_ViewVocbase);
  TRI_AddMethodVocbase(isolate, AvocadoDBNS, TRI_V8_ASCII_STRING("_views"),
                       JS_ViewsVocbase);
  ...
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoView"));
  ...
  TRI_AddGlobalFunctionVocbase(isolate, TRI_V8_ASCII_STRING("AvocadoView"),
                               ft->GetFunction());
}
