...
#ifndef AVOCADOD_REST_HANDLER_REST_IMPORT_HANDLER_H
#define AVOCADOD_REST_HANDLER_REST_IMPORT_HANDLER_H 1
...
class RestImportHandler : public RestVocbaseBaseHandler {
 ...
 private:
  ...
  int handleSingleDocument(SingleCollectionTransaction& trx,
                           ...
                           avocadodb::velocypack::Builder& babies,
  ...
  void createVelocyPackObject(VPackBuilder&,
      avocadodb::velocypack::Slice const&, avocadodb::velocypack::Slice const&,
      std::string&, size_t);
  ...
  bool checkKeys(avocadodb::velocypack::Slice const&) const;
