...
void RestVocbaseBaseHandler::generateSaved(
    avocadodb::OperationResult const& result, std::string const& collectionName,
...
////////////////////////////////////////////////////////////////////////////////
/// @brief prepareExecute, to react to X-Avocado-Nolock header
////////////////////////////////////////////////////////////////////////////////
...
void RestVocbaseBaseHandler::prepareExecute() {
  ...
  bool found;
  std::string const& shardId = _request->header("x-avocado-nolock", found);
...
////////////////////////////////////////////////////////////////////////////////
/// @brief finalizeExecute, to react to X-Avocado-Nolock header
////////////////////////////////////////////////////////////////////////////////
