...
#ifndef AVOCADOD_REST_HANDLER_WORK_MONITOR_HANDLER_H
#define AVOCADOD_REST_HANDLER_WORK_MONITOR_HANDLER_H 1

#include "RestHandler/RestBaseHandler.h"

namespace avocadodb {
class WorkMonitorHandler : public avocadodb::RestBaseHandler {
 public:
