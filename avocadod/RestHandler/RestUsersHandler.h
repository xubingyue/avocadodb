...
#ifndef AVOCADOD_REST_HANDLER_REST_USERS_HANDLER_H
#define AVOCADOD_REST_HANDLER_REST_USERS_HANDLER_H 1
...
class RestUsersHandler : public avocadodb::RestBaseHandler {
 public:
