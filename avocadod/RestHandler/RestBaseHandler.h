...
#ifndef AVOCADOD_REST_HANDLER_REST_BASE_HANDLER_H
#define AVOCADOD_REST_HANDLER_REST_BASE_HANDLER_H 1
...
class RestBaseHandler : public rest::RestHandler {
 ...
 public:
  ...
  // generates an error
  void generateError(avocadodb::Result const&);
 ...
 protected:
  ...
  std::shared_ptr<avocadodb::velocypack::Builder> parseVelocyPackBody(bool& success);

  template <typename Payload>
  void writeResult(Payload&&, avocadodb::velocypack::Options const& options);
};
}
