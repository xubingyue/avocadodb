...
void RestSimpleHandler::registerQuery(avocadodb::aql::Query* query) {
...
void RestSimpleHandler::removeByKeys(VPackSlice const& slice) {
  ...
  try {
    ...
    avocadodb::aql::Query query(false, _vocbase, avocadodb::aql::QueryString(aql),
...
void RestSimpleHandler::lookupByKeys(VPackSlice const& slice) {
  ...
  try {
    ...
    VPackBuilder strippedBuilder =
        avocadodb::aql::BindParameters::StripCollectionNames(
