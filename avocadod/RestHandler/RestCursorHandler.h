...
#ifndef AVOCADOD_REST_HANDLER_REST_CURSOR_HANDLER_H
#define AVOCADOD_REST_HANDLER_REST_CURSOR_HANDLER_H 1
...
class RestCursorHandler : public RestVocbaseBaseHandler {
 ...
 protected:
  ...
  void processQuery(avocadodb::velocypack::Slice const&);
 ...
 private:
  ...
  avocadodb::velocypack::Builder buildOptions(
  ...
  std::shared_ptr<avocadodb::velocypack::Builder> buildExtra(
      avocadodb::aql::QueryResult&) const;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief append the contents of the cursor into the response body
  //////////////////////////////////////////////////////////////////////////////

  void dumpCursor(avocadodb::Cursor*);
