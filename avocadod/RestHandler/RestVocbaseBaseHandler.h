...
class RestVocbaseBaseHandler : public RestBaseHandler {
 ...
 protected:
  ...
  void generate20x(avocadodb::OperationResult const&, std::string const&,
                   TRI_col_type_e, avocadodb::velocypack::Options const*);
  ...
  void generateSaved(avocadodb::OperationResult const& result,
                     std::string const& collectionName, TRI_col_type_e type,
                     avocadodb::velocypack::Options const*, bool isMultiple);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief generates deleted message
  //////////////////////////////////////////////////////////////////////////////

  void generateDeleted(avocadodb::OperationResult const& result,
                       std::string const& collectionName, TRI_col_type_e type,
  ...
  void generatePreconditionFailed(avocadodb::velocypack::Slice const& slice);
  ...
  void generateDocument(avocadodb::velocypack::Slice const&, bool,
                        avocadodb::velocypack::Options const* options = nullptr);
