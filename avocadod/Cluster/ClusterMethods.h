...
int createDocumentOnCoordinator(
    ...
    OperationOptions const& options, avocadodb::velocypack::Slice const& slice,
...
int fetchEdgesFromEngines(
    ...
    avocadodb::velocypack::Slice vertexId, size_t,
    std::unordered_map<StringRef, avocadodb::velocypack::Slice>&,
    std::vector<avocadodb::velocypack::Slice>&,
    std::vector<std::shared_ptr<avocadodb::velocypack::Builder>>&,
    avocadodb::velocypack::Builder&, size_t&, size_t&);
...
int fetchEdgesFromEngines(
    ...
    avocadodb::velocypack::Slice vertexId,
    bool backward,
    std::unordered_map<StringRef, avocadodb::velocypack::Slice>& cache,
    std::vector<avocadodb::velocypack::Slice>& result,
    std::vector<std::shared_ptr<avocadodb::velocypack::Builder>>& datalake,
    avocadodb::velocypack::Builder& builder, size_t& read);
...
void fetchVerticesFromEngines(
    ...
    std::unordered_map<StringRef, std::shared_ptr<avocadodb::velocypack::Buffer<uint8_t>>>&,
...
int modifyDocumentOnCoordinator(
    std::string const& dbname, std::string const& collname,
    avocadodb::velocypack::Slice const& slice, OperationOptions const& options,
    bool isPatch,
    std::unique_ptr<std::unordered_map<std::string, std::string>>& headers,
    avocadodb::rest::ResponseCode& responseCode,
    std::unordered_map<int, size_t>& errorCounter,
...
////////////////////////////////////////////////////////////////////////////////
  ...
  static std::unique_ptr<LogicalCollection> persistCollectionInAgency(
    ...
    bool waitForSyncReplication, avocadodb::velocypack::Slice parameters);
};
