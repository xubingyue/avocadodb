...
static inline bool hasError(VPackSlice const& slice) {
  return avocadodb::basics::VelocyPackHelper::getBooleanValue(slice, "error",
                                                             false);
}
...
static std::string extractErrorMessage(std::string const& shardId,
  ...
  msg += avocadodb::basics::VelocyPackHelper::getStringValue(slice,
                                                            "errorMessage", "");
  ...
  if (slice.hasKey("errorNum")) {
    ...
    if (errorNum.isNumber()) {
      msg += " (errNum=" + avocadodb::basics::StringUtils::itoa(
...
////////////////////////////////////////////////////////////////////////////////
/// @brief create database in coordinator, the return value is an AvocadoDB
      ...
      [=](VPackSlice const& result) {
        ...
        if (result.isObject() && result.length() >= numDbServers) {
          ...
          for (auto const& dbserver : dbs) {
            ...
            if (avocadodb::basics::VelocyPackHelper::getBooleanValue(
                  slice, "error", false)) {
              tmpHaveError = true;
              tmpMsg += " DBServer:" + dbserver.key.copyString() + ":";
              tmpMsg += avocadodb::basics::VelocyPackHelper::getStringValue(
                  slice, "errorMessage", "");
              if (slice.hasKey("errorNum")) {
...
////////////////////////////////////////////////////////////////////////////////
/// @brief drop database in coordinator, the return value is an AvocadoDB
/// error code and the errorMsg is set accordingly. One possible error
/// is a timeout, a timeout of 0.0 means no timeout.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief create collection in coordinator, the return value is an AvocadoDB
/// error code and the errorMsg is set accordingly. One possible error
/// is a timeout, a timeout of 0.0 means no timeout.
////////////////////////////////////////////////////////////////////////////////
...
int ClusterInfo::createCollectionCoordinator(std::string const& databaseName,
                                             ...
                                             std::string& errorMsg,
                                             double timeout) {
  using avocadodb::velocypack::Slice;
  ...
  std::string const name =
      avocadodb::basics::VelocyPackHelper::getStringValue(json, "name", "");
        ...
        if (result.isObject() && result.length() == (size_t)numberOfShards) {
          ...
          for (auto const& p : VPackObjectIterator(result)) {
            if (avocadodb::basics::VelocyPackHelper::getBooleanValue(
              ...
              tmpError += avocadodb::basics::VelocyPackHelper::getStringValue(
...
////////////////////////////////////////////////////////////////////////////////
/// @brief drop collection in coordinator, the return value is an AvocadoDB
/// error code and the errorMsg is set accordingly. One possible error
/// is a timeout, a timeout of 0.0 means no timeout.
////////////////////////////////////////////////////////////////////////////////
...
int ClusterInfo::ensureIndexCoordinator(
  ...
  if (idSlice.isString()) {
    ...
    iid = avocadodb::basics::StringUtils::uint64(idSlice.copyString());
  }
  ...
  std::string const idString = avocadodb::basics::StringUtils::itoa(iid);
...

  {
    ...
    if (indexes.isArray()) {
      ...
      for (auto const& other : VPackArrayIterator(indexes)) {
        if (avocadodb::basics::VelocyPackHelper::compare(type, other.get("type"),
                                                        false) != 0) {
...
int ClusterInfo::getResponsibleShard(LogicalCollection* collInfo,
  ...
  uint64_t hash = avocadodb::basics::VelocyPackHelper::hashByAttributes(
