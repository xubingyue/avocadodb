...
#define ONLY_IN_CLUSTER                                 \
  if (!ServerState::instance()->isRunningInCluster()) { \
    TRI_V8_THROW_EXCEPTION_INTERNAL(                    \
        "AvocadoDB is not running in cluster mode");     \
  }
...
static void CreateAgencyException(
  ...
  v8::Handle<v8::Value> proto = AvocadoErrorTempl->NewInstance();
  if (!proto.IsEmpty()) {
...
////////////////////////////////////////////////////////////////////////////////
/// @brief set avocadoserver state to initialized
////////////////////////////////////////////////////////////////////////////////
...
static void PrepareClusterCommRequest(
    v8::FunctionCallbackInfo<v8::Value> const& args,
    avocadodb::rest::RequestType& reqType, std::string& destination,
  ...
  if (args[0]->IsString()) {
    ...
    reqType = avocadodb::HttpRequest::translateMethod(methstring);
    if (reqType == avocadodb::rest::RequestType::ILLEGAL) {
      reqType = avocadodb::rest::RequestType::GET;
    }
  }
...
void TRI_InitV8Cluster(v8::Isolate* isolate, v8::Handle<v8::Context> context) {
  ...
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoAgency"));
  ...
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoAgencyCtor"));

  TRI_AddGlobalFunctionVocbase(isolate,
                               TRI_V8_ASCII_STRING("AvocadoAgencyCtor"),
                               ft->GetFunction(), true);
  ...
  if (!aa.IsEmpty()) {
    TRI_AddGlobalVariableVocbase(isolate, 
                                 TRI_V8_ASCII_STRING("AvocadoAgency"), aa);
  }
  ...
  ft = v8::FunctionTemplate::New(isolate);
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoClusterInfo"));
  ...
  TRI_AddGlobalFunctionVocbase(isolate,
                               TRI_V8_ASCII_STRING("AvocadoClusterInfoCtor"),
                               ft->GetFunction(), true);
  ...
  if (!ci.IsEmpty()) {
    TRI_AddGlobalVariableVocbase(isolate,
                                 TRI_V8_ASCII_STRING("AvocadoClusterInfo"), ci);
  }
  ...
  ft = v8::FunctionTemplate::New(isolate);
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoServerState"));
  ...
  TRI_AddGlobalFunctionVocbase(isolate,
                               TRI_V8_ASCII_STRING("AvocadoServerStateCtor"),
                               ft->GetFunction(), true);
  ...
  if (!ss.IsEmpty()) {
    TRI_AddGlobalVariableVocbase(isolate,
                                 TRI_V8_ASCII_STRING("AvocadoServerState"), ss);
  }
  ...
  ft = v8::FunctionTemplate::New(isolate);
  ft->SetClassName(TRI_V8_ASCII_STRING("AvocadoClusterComm"));
  ...
  TRI_AddGlobalFunctionVocbase(isolate,
                               TRI_V8_ASCII_STRING("AvocadoClusterCommCtor"),
                               ft->GetFunction(), true);
  ...
  if (!ss.IsEmpty()) {
    TRI_AddGlobalVariableVocbase(isolate,
                                 TRI_V8_ASCII_STRING("AvocadoClusterComm"), ss);
  }
