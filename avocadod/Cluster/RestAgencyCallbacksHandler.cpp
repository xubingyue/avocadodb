...
RestAgencyCallbacksHandler::RestAgencyCallbacksHandler(GeneralRequest* request,
    ...
    avocadodb::AgencyCallbackRegistry* agencyCallbackRegistry)
...
RestStatus RestAgencyCallbacksHandler::execute() {
  ...
  try {
    ...
    resetResponse(avocadodb::rest::ResponseCode::ACCEPTED);
  } catch (avocadodb::basics::Exception const&) {
    // mop: not found...expected
    resetResponse(avocadodb::rest::ResponseCode::NOT_FOUND);
  }
  return RestStatus::DONE;
}
