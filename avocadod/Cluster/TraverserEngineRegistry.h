...
#ifndef AVOCADOD_CLUSTER_TRAVERSER_ENGINE_REGISTRY_H
#define AVOCADOD_CLUSTER_TRAVERSER_ENGINE_REGISTRY_H 1
...
class TraverserEngineRegistry {
 ...
 public:
  ...
  TraverserEngineID createNew(TRI_vocbase_t*, avocadodb::velocypack::Slice,
                              double ttl = 600.0);
 ...
 private:
  ...
  struct EngineInfo {
    ...
    EngineInfo(TRI_vocbase_t*, avocadodb::velocypack::Slice);
    ~EngineInfo();
  };
