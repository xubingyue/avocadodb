...
class LoggerView final : public ViewImplementation {
 public:
  ...
  static std::unique_ptr<ViewImplementation> creator(
      LogicalView*, avocadodb::velocypack::Slice const& info, bool isNew);
 ...
 public:
  ...
  avocadodb::Result updateProperties(avocadodb::velocypack::Slice const& slice,
