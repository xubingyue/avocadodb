...
class ViewIterator {
 public:
  ...
  typedef std::function<void(DocumentIdentifierToken const& token, avocadodb::velocypack::Slice extra)> ExtraCallback; 
  ...
  bool readDocument(avocadodb::DocumentIdentifierToken const& token, avocadodb::ManagedDocumentResult& result) const; 
