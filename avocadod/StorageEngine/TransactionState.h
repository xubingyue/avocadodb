...
#define LOG_TRX(...) \
  while (0) LOG_TOPIC(TRACE, avocadodb::Logger::TRANSACTIONS)
...
class TransactionState {
 public:
  ...
  virtual avocadodb::Result beginTransaction(transaction::Hints hints) = 0;

  /// @brief commit a transaction
  virtual avocadodb::Result commitTransaction(transaction::Methods* trx) = 0;

  /// @brief abort a transaction
  virtual avocadodb::Result abortTransaction(transaction::Methods* trx) = 0;
