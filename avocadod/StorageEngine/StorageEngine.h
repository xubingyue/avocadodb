...
#ifndef AVOCADOD_STORAGE_ENGINE_STORAGE_ENGINE_H
#define AVOCADOD_STORAGE_ENGINE_STORAGE_ENGINE_H 1
...
class StorageEngine : public application_features::ApplicationFeature {
 ...
 public:
  ...
  virtual void getDatabases(avocadodb::velocypack::Builder& result) = 0;
  ...
  // for each database
  virtual int getCollectionsAndIndexes(TRI_vocbase_t* vocbase, avocadodb::velocypack::Builder& result,
                                       bool wasCleanShutdown, bool isUpgrade) = 0;
  
  virtual int getViews(TRI_vocbase_t* vocbase, avocadodb::velocypack::Builder& result) = 0;
  ...
  virtual TRI_vocbase_t* openDatabase(avocadodb::velocypack::Slice const& args, bool isUpgrade, int& status) = 0;
  TRI_vocbase_t* openDatabase(avocadodb::velocypack::Slice const& args, bool isUpgrade){
    int status;
  ...
  virtual TRI_vocbase_t* createDatabase(TRI_voc_tick_t id, avocadodb::velocypack::Slice const& args, int& status) = 0;
  TRI_vocbase_t* createDatabase(TRI_voc_tick_t id, avocadodb::velocypack::Slice const& args ){
    int status;
  ...
  virtual std::string createCollection(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                                       avocadodb::LogicalCollection const*) = 0;

  // asks the storage engine to persist the collection.
  // After this call the collection is persisted over recovery.
  virtual avocadodb::Result persistCollection(
      TRI_vocbase_t* vocbase,
      avocadodb::LogicalCollection const* collection) = 0;
  ...
  virtual avocadodb::Result dropCollection(TRI_vocbase_t* vocbase, avocadodb::LogicalCollection* collection) = 0;
  ...
  virtual void destroyCollection(TRI_vocbase_t* vocbase, avocadodb::LogicalCollection* collection) = 0;
  ...
  virtual avocadodb::Result renameCollection(
  ...
  virtual void createView(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                          avocadodb::LogicalView const*) = 0;

  // asks the storage engine to persist the view.
  // After this call the view is persisted over recovery.
  virtual avocadodb::Result persistView(
      TRI_vocbase_t* vocbase, avocadodb::LogicalView const*) = 0;
  ...
  // to "dropView" returns
  virtual avocadodb::Result dropView(TRI_vocbase_t* vocbase, avocadodb::LogicalView*) = 0;
  ...
  virtual void destroyView(TRI_vocbase_t* vocbase, avocadodb::LogicalView*) = 0;
  ...
  virtual void changeView(TRI_vocbase_t* vocbase, TRI_voc_cid_t id,
                          avocadodb::LogicalView const*, bool doSync) = 0;
  ...
  virtual void createIndex(TRI_vocbase_t* vocbase, TRI_voc_cid_t collectionId,
                           TRI_idx_iid_t id, avocadodb::velocypack::Slice const& data) = 0;
  ...
  virtual void unloadCollection(TRI_vocbase_t* vocbase, avocadodb::LogicalCollection* collection) = 0;
  ...
  // replication
  virtual std::shared_ptr<avocadodb::velocypack::Builder> getReplicationApplierConfiguration(TRI_vocbase_t*, int& status) = 0;
  virtual int removeReplicationApplierConfiguration(TRI_vocbase_t* vocbase) = 0;
  virtual int saveReplicationApplierConfiguration(TRI_vocbase_t* vocbase, avocadodb::velocypack::Slice slice, bool doSync) = 0; 

  virtual int handleSyncKeys(avocadodb::InitialSyncer& syncer,
