...
#ifndef AVOCADOD_TRANSACTION_STANDALONE_CONTEXT_H
#define AVOCADOD_TRANSACTION_STANDALONE_CONTEXT_H 1
...
class StandaloneContext final : public Context {
 ...
 public:
  ...
  std::shared_ptr<avocadodb::velocypack::CustomTypeHandler>
