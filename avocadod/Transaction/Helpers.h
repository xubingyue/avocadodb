...
#ifndef AVOCADOD_TRANSACTION_HELPERS_H
#define AVOCADOD_TRANSACTION_HELPERS_H 1
...
class StringBufferLeaser {
 public:
  ...
  ~StringBufferLeaser();
  avocadodb::basics::StringBuffer* stringBuffer() const { return _stringBuffer; }
  avocadodb::basics::StringBuffer* operator->() const { return _stringBuffer; }
  avocadodb::basics::StringBuffer* get() const { return _stringBuffer; }
 private:
  transaction::Context* _transactionContext;
  avocadodb::basics::StringBuffer* _stringBuffer;
};
...
class BuilderLeaser {
 public:
  ...
  ~BuilderLeaser();
  inline avocadodb::velocypack::Builder* builder() const { return _builder; }
  inline avocadodb::velocypack::Builder* operator->() const { return _builder; }
  inline avocadodb::velocypack::Builder* get() const { return _builder; }
  inline avocadodb::velocypack::Builder* steal() { 
    avocadodb::velocypack::Builder* res = _builder;
    _builder = nullptr;
    return res;
  }
 private:
