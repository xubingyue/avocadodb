...
#ifndef AVOCADOD_TRANSACTION_METHODS_H
#define AVOCADOD_TRANSACTION_METHODS_H 1
...
class Methods {
 ...
 public:
  class IndexHandle {
    ...
    std::shared_ptr<avocadodb::Index> _index;
   public:
    IndexHandle() = default;
    void toVelocyPack(avocadodb::velocypack::Builder& builder,
    ...
    explicit IndexHandle(std::shared_ptr<avocadodb::Index> const& idx) : _index(idx) {}
    std::vector<std::vector<std::string>> fieldNames() const;

   public:
    std::shared_ptr<avocadodb::Index> getIndex() const;
  };
 ...
 public:
  ...
  void registerCallback(std::function<void(avocadodb::transaction::Methods* trx)> const& onFinish) { _onFinish = onFinish; }
  ...
  void invokeOnAllElements(std::string const& collectionName,
                           std::function<bool(avocadodb::DocumentIdentifierToken const&)>);
  ...
  Result documentFastPath(std::string const& collectionName,
                       ...
                       avocadodb::velocypack::Slice const value,
  ...
  std::pair<bool, bool> getBestIndexHandlesForFilterCondition(
      std::string const&, avocadodb::aql::Ast*, avocadodb::aql::AstNode*,
      avocadodb::aql::Variable const*, avocadodb::aql::SortCondition const*,
  ...
  std::vector<std::vector<avocadodb::basics::AttributeName>> getIndexFeatures(
  ...
  std::pair<bool, bool> getIndexForSortCondition(
      std::string const&, avocadodb::aql::SortCondition const*,
  ...
  bool isLocked(avocadodb::LogicalCollection*, AccessMode::Type);

  avocadodb::LogicalCollection* documentCollection(TRI_voc_cid_t) const;
...
/// @brief get all indexes for a collection name
  std::vector<std::shared_ptr<avocadodb::Index>> indexesForCollection(
      std::string const&);
 ...
 private:
  ...
  void buildDocumentIdentity(avocadodb::LogicalCollection* collection,
 ...
 protected:
  ...
  avocadodb::LogicalCollection* documentCollection(
...
/// @brief Helper create a Cluster Communication document
  OperationResult clusterResultDocument(
      ...
      std::shared_ptr<avocadodb::velocypack::Builder> const& resultBody,
...
/// @brief Helper create a Cluster Communication remove result
  ...
  bool sortOrs(avocadodb::aql::Ast* ast,
               avocadodb::aql::AstNode* root,
  ...
  std::pair<bool, bool> findIndexHandleForAndNode(
      ...
      std::vector<transaction::Methods::IndexHandle>& usedIndexes,
      avocadodb::aql::AstNode*& specializedCondition,
      bool& isSparse) const;
  ...
  std::shared_ptr<avocadodb::Index> indexForCollectionCoordinator(
      std::string const&, std::string const&) const;

  /// @brief Get all indexes for a collection name, coordinator case
  std::vector<std::shared_ptr<avocadodb::Index>> indexesForCollectionCoordinator(
 ...
 private:
  ...
  /// commit or abort
  std::function<void(avocadodb::transaction::Methods* trx)> _onFinish;
};
