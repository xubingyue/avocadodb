...
using namespace avocadodb::transaction;
using namespace avocadodb::transaction::helpers;
...
static bool indexSupportsSort(Index const* idx,
                              ...
                              avocadodb::aql::SortCondition const* sortCondition,
...
static OperationResult dbServerResponseBad(
  ...
  return OperationResult(
      ...
      avocadodb::basics::VelocyPackHelper::getStringValue(
...
std::shared_ptr<avocadodb::Index> transaction::Methods::IndexHandle::getIndex()
    const {
  return _index;
}
...
void transaction::Methods::IndexHandle::toVelocyPack(
    avocadodb::velocypack::Builder& builder, bool withFigures) const {
...
bool transaction::Methods::sortOrs(
    avocadodb::aql::Ast* ast, avocadodb::aql::AstNode* root,
    avocadodb::aql::Variable const* variable,
  ...
  typedef std::pair<avocadodb::aql::AstNode*, transaction::Methods::IndexHandle>
      ConditionData;
  ...
  std::vector<avocadodb::aql::ConditionPart> parts;
  parts.reserve(n);
  ...
  for (size_t i = 0; i < n; ++i) {
    ...
    TRI_ASSERT(sub != nullptr &&
               sub->type ==
                   avocadodb::aql::AstNodeType::NODE_TYPE_OPERATOR_NARY_AND);
    ...
    if (operand->type ==
            avocadodb::aql::AstNodeType::NODE_TYPE_OPERATOR_BINARY_NE ||
        operand->type ==
            avocadodb::aql::AstNodeType::NODE_TYPE_OPERATOR_BINARY_NIN) {
      return false;
    }
    ...
    if (lhs->type == avocadodb::aql::AstNodeType::NODE_TYPE_ATTRIBUTE_ACCESS) {
      ...
      if (rhs->isConstant() && lhs->isAttributeAccessForVariable(result) &&
          ...
          (operand->type !=
               avocadodb::aql::AstNodeType::NODE_TYPE_OPERATOR_BINARY_IN ||
           rhs->isArray())) {
        ...
        parts.emplace_back(avocadodb::aql::ConditionPart(
            result.first, result.second, operand,
            avocadodb::aql::AttributeSideType::ATTRIBUTE_LEFT, p));
      }
    }

    if (rhs->type == avocadodb::aql::AstNodeType::NODE_TYPE_ATTRIBUTE_ACCESS ||
        rhs->type == avocadodb::aql::AstNodeType::NODE_TYPE_EXPANSION) {
      std::pair<avocadodb::aql::Variable const*,
                std::vector<avocadodb::basics::AttributeName>>
          result;
      ...
      if (lhs->isConstant() && rhs->isAttributeAccessForVariable(result) &&
        ...
        parts.emplace_back(avocadodb::aql::ConditionPart(
            result.first, result.second, operand,
            avocadodb::aql::AttributeSideType::ATTRIBUTE_RIGHT, p));
      }
    }
  }
  ...
  std::sort(parts.begin(), parts.end(),
            [](avocadodb::aql::ConditionPart const& lhs,
               avocadodb::aql::ConditionPart const& rhs) -> bool {
...
std::pair<bool, bool> transaction::Methods::findIndexHandleForAndNode(
    std::vector<std::shared_ptr<Index>> indexes, avocadodb::aql::AstNode* node,
    avocadodb::aql::Variable const* reference,
    avocadodb::aql::SortCondition const* sortCondition, size_t itemsInCollection,
    std::vector<transaction::Methods::IndexHandle>& usedIndexes,
    avocadodb::aql::AstNode*& specializedCondition, bool& isSparse) const {
...
bool transaction::Methods::findIndexHandleForAndNode(
    std::vector<std::shared_ptr<Index>> indexes, avocadodb::aql::AstNode*& node,
    avocadodb::aql::Variable const* reference, size_t itemsInCollection,
...
OperationResult transaction::Methods::documentCoordinator(
  ...
  int res = avocadodb::getDocumentOnCoordinator(
...
OperationResult transaction::Methods::insertCoordinator(
  ...
  int res = avocadodb::createDocumentOnCoordinator(
...
static double chooseTimeout(size_t count) {
  ...
  if (!timeoutQueried) {
    ...
    if (feature2->engineName() == avocadodb::RocksDBEngine::EngineName) {
      lowerLimit = 1.0;
    }
  }
...
OperationResult transaction::Methods::insertLocal(
  ...
  if (res.ok() && _state->isDBServer()) {
    ...
    if (doingSynchronousReplication) {
      ...
      std::string path =
        "/_db/" + avocadodb::basics::StringUtils::urlEncode(databaseName()) +
        "/_api/document/" +
        avocadodb::basics::StringUtils::urlEncode(collection->name()) +
      ...
      if (count > 0) {
        ...
        *body = payload.slice().toJson();
        ...
        for (auto const& f : *followers) {
          requests.emplace_back("server:" + f, avocadodb::rest::RequestType::POST,
              path, body);
        }
...
OperationResult transaction::Methods::updateCoordinator(
  ...
  int res = avocadodb::modifyDocumentOnCoordinator(
          ...
          *body = payload.slice().toJson();
          ...
          for (auto const& f : *followers) {
            requests.emplace_back("server:" + f,
                ...
                ? avocadodb::rest::RequestType::PUT
                : avocadodb::rest::RequestType::PATCH,
                path, body);
          }
          size_t nrDone = 0;
          size_t nrGood = cc->performRequests(requests, chooseTimeout(count),
...
OperationResult transaction::Methods::removeCoordinator(
  ...
  int res = avocadodb::deleteDocumentOnCoordinator(
      ...
      if (cc != nullptr) {
        ...
        if (count > 0) {
          ...
          *body = payload.slice().toJson();
          ...
          for (auto const& f : *followers) {
            requests.emplace_back("server:" + f,
                avocadodb::rest::RequestType::DELETE_REQ, path,
                body);
          }
          size_t nrDone = 0;
          size_t nrGood = cc->performRequests(requests, chooseTimeout(count),
...
OperationResult transaction::Methods::truncateCoordinator(
  ...
  return OperationResult(avocadodb::truncateCollectionOnCoordinator(
    ...
    if (!isFollower && followers->size() > 0) {
      ...
      if (cc != nullptr) {
        ...
        std::string path =
            "/_db/" + avocadodb::basics::StringUtils::urlEncode(databaseName()) +
            "/_api/collection/" +
            avocadodb::basics::StringUtils::urlEncode(collectionName) +
        ...
        std::vector<ClusterCommRequest> requests;
        for (auto const& f : *followers) {
          requests.emplace_back("server:" + f, avocadodb::rest::RequestType::PUT,
                                path, body);
        }
        size_t nrDone = 0;
...
OperationResult transaction::Methods::countCoordinator(
  ...
  int res = avocadodb::countOnCoordinator(databaseName(), collectionName, count);
...
transaction::Methods::getBestIndexHandlesForFilterCondition(
    std::string const& collectionName, avocadodb::aql::Ast* ast,
    avocadodb::aql::AstNode* root, avocadodb::aql::Variable const* reference,
    avocadodb::aql::SortCondition const* sortCondition, size_t itemsInCollection,
    std::vector<IndexHandle>& usedIndexes, bool& isSorted) {
  // We can only start after DNF transformation
  TRI_ASSERT(root->type ==
             avocadodb::aql::AstNodeType::NODE_TYPE_OPERATOR_NARY_OR);
  ...
  for (size_t i = 0; i < root->numMembers(); ++i) {
    ...
    avocadodb::aql::AstNode* specializedCondition = nullptr;
...
bool transaction::Methods::getBestIndexHandleForFilterCondition(
    std::string const& collectionName, avocadodb::aql::AstNode*& node,
    avocadodb::aql::Variable const* reference, size_t itemsInCollection,
...
bool transaction::Methods::supportsFilterCondition(
    IndexHandle const& indexHandle, avocadodb::aql::AstNode const* condition,
...
std::vector<std::vector<avocadodb::basics::AttributeName>>
...
OperationCursor* transaction::Methods::indexScanForCondition(
    IndexHandle const& indexId, avocadodb::aql::AstNode const* condition,
    avocadodb::aql::Variable const* var, ManagedDocumentResult* mmdr,
...
avocadodb::LogicalCollection* transaction::Methods::documentCollection(
...
std::shared_ptr<Index> transaction::Methods::indexForCollectionCoordinator(
  ...
  auto clusterInfo = avocadodb::ClusterInfo::instance();
...
Result transaction::Methods::resolveId(char const* handle, size_t length,
  ...
  if (*handle >= '0' && *handle <= '9') {
    cid = avocadodb::basics::StringUtils::uint64(handle, p - handle);
  } else {
