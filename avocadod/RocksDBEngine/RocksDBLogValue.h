...
class RocksDBLogValue {
 public:
  ...
  static RocksDBLogValue DocumentRemove(avocadodb::StringRef const&);
 ...
 public:
  ...
  static avocadodb::StringRef newCollectionName(rocksdb::Slice const&);
  static avocadodb::StringRef documentKey(rocksdb::Slice const&);
