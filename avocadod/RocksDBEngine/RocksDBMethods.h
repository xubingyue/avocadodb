...
class RocksDBMethods {
 public:
  ...
  virtual avocadodb::Result Get(rocksdb::ColumnFamilyHandle*, RocksDBKey const&,
                               std::string*) = 0;
  virtual avocadodb::Result Put(
      rocksdb::ColumnFamilyHandle*, RocksDBKey const&, rocksdb::Slice const&,
      rocksutils::StatusHint hint = rocksutils::StatusHint::none) = 0;
  
  virtual avocadodb::Result Delete(rocksdb::ColumnFamilyHandle*,
                                  RocksDBKey const&) = 0;
...
class RocksDBReadOnlyMethods : public RocksDBMethods {
 public:
  ...
  avocadodb::Result Get(rocksdb::ColumnFamilyHandle*, RocksDBKey const& key,
                       std::string* val) override;

  avocadodb::Result Put(
      rocksdb::ColumnFamilyHandle*, RocksDBKey const& key,
      rocksdb::Slice const& val,
      rocksutils::StatusHint hint = rocksutils::StatusHint::none) override;
  avocadodb::Result Delete(rocksdb::ColumnFamilyHandle*,
  ...
  avocadodb::Result RollbackToSavePoint() override { return avocadodb::Result(); }
...
class RocksDBTrxMethods : public RocksDBMethods {
 public:
  ...
  void SetSavePoint() override;
  avocadodb::Result RollbackToSavePoint() override;
};
