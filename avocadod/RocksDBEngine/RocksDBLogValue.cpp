...
avocadodb::StringRef RocksDBLogValue::newCollectionName(
...
avocadodb::StringRef RocksDBLogValue::documentKey(rocksdb::Slice const& slice) {
  RocksDBLogType type = static_cast<RocksDBLogType>(slice.data()[0]);
