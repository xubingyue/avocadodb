...
class RocksDBEngine final : public StorageEngine {
 ...
 public:
  ...
  void addParametersForNewCollection(avocadodb::velocypack::Builder& builder,
                                     avocadodb::velocypack::Slice info) override;
  void addParametersForNewIndex(avocadodb::velocypack::Builder& builder,
                                avocadodb::velocypack::Slice info) override;
 ...
 public:
  ...
  avocadodb::Result syncWal(bool waitForSync = false,
