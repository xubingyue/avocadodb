...
class RocksDBCounterManager {
 ...
 public:
  ...
  avocadodb::Result setAbsoluteCounter(uint64_t objectId,
  ...
  avocadodb::Result sync(bool force);
  ...
  // estimator
  // for this index.
  std::unique_ptr<avocadodb::RocksDBCuckooIndexEstimator<uint64_t>>
 ...
 protected:
  struct CMValue {
    ...
    explicit CMValue(avocadodb::velocypack::Slice const&);
    void serialize(avocadodb::velocypack::Builder&) const;
  };
