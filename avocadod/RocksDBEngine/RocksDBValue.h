...
#ifndef AVOCADO_ROCKSDB_ROCKSDB_VALUE_H
#define AVOCADO_ROCKSDB_ROCKSDB_VALUE_H 1
...
class RocksDBValue {
 public:
  ...
  static RocksDBValue EdgeIndexValue(avocadodb::StringRef const& vertexId);
 ...
 private:
  ...
  RocksDBValue(RocksDBEntryType type, avocadodb::StringRef const& data);
