...
class RocksDBFulltextIndex final : public RocksDBIndex {
 ...
 public:
  ...
  avocadodb::Result parseQueryString(std::string const&, FulltextQuery&);
  avocadodb::Result executeQuery(transaction::Methods* trx, FulltextQuery const&,
                                size_t maxResults,
 ...
 private:
  std::set<std::string> wordlist(avocadodb::velocypack::Slice const&);
  ...
  avocadodb::Result applyQueryToken(transaction::Methods* trx,
