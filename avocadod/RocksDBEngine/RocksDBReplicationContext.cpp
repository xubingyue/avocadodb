...
RocksDBReplicationResult RocksDBReplicationContext::dump(
  ...
  avocadodb::basics::VPackStringBufferAdapter adapter(buff.stringBuffer());
...
avocadodb::Result RocksDBReplicationContext::dumpKeyChunks(VPackBuilder& b,
                                                          uint64_t chunkSize) {
  Result rv;
...
avocadodb::Result RocksDBReplicationContext::dumpKeys(
...
avocadodb::Result RocksDBReplicationContext::dumpDocuments(
