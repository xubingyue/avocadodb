...
#ifndef AVOCADOD_ROCKSDB_ROCKSDB_INDEX_FACTORY_H
#define AVOCADOD_ROCKSDB_ROCKSDB_INDEX_FACTORY_H 1
...
class RocksDBIndexFactory final : public IndexFactory {
 public:
  ...
  int enhanceIndexDefinition(avocadodb::velocypack::Slice const definition,
                             avocadodb::velocypack::Builder& enhanced,
                             bool isCreation,
