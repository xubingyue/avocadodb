...
class DatabaseFeature final : public application_features::ApplicationFeature {
 ...
 private:
  ...
  int iterateDatabases(avocadodb::velocypack::Slice const& databases);
 ...
 private:
  ...
  // avocadodb::basics::DataProtector<64>
  avocadodb::basics::DataProtector _databasesProtector;
  avocadodb::Mutex _databasesMutex;
  ...
  avocadodb::Mutex _databaseCreateLock;
};
}
