...
AttributeWeightShortestPathFinder::Step::Step(
    avocadodb::StringRef const& vert, avocadodb::StringRef const& pred,
...
AttributeWeightShortestPathFinder::Searcher::Searcher(
    ...
    ThreadInfo& peerInfo, avocadodb::StringRef const& start, bool isBackward)
...
void AttributeWeightShortestPathFinder::Searcher::lookupPeer(
    avocadodb::StringRef& vertex, double weight) {
...
bool AttributeWeightShortestPathFinder::shortestPath(
    avocadodb::velocypack::Slice const& st,
    avocadodb::velocypack::Slice const& ta, ShortestPathResult& result,
  ...
  avocadodb::StringRef emptyVertex;
  ThreadInfo forward;
...
void AttributeWeightShortestPathFinder::expandVertex(
    bool isBackward, avocadodb::StringRef const& vertex,
...
AttributeWeightShortestPathFinder::SearcherTwoThreads::SearcherTwoThreads(
    AttributeWeightShortestPathFinder* pathFinder, ThreadInfo& myInfo,
    ThreadInfo& peerInfo, avocadodb::velocypack::Slice const& start,
...
void AttributeWeightShortestPathFinder::SearcherTwoThreads::lookupPeer(
    avocadodb::velocypack::Slice& vertex, double weight) {
...
bool AttributeWeightShortestPathFinder::shortestPathTwoThreads(
    avocadodb::velocypack::Slice& start, avocadodb::velocypack::Slice& target,
  ...
  // Forward with initialization:
  avocadodb::velocypack::Slice emptyVertex;
  avocadodb::velocypack::Slice emptyEdge;
  ThreadInfo forward;
