...
class ShortestPathResult {
  friend class avocadodb::graph::AttributeWeightShortestPathFinder;
  friend class avocadodb::graph::ConstantWeightShortestPathFinder;
 ...
 private:
  ...
  /// @brief vertices
  std::deque<avocadodb::StringRef> _vertices;

  /// @brief edges
  std::deque<std::unique_ptr<avocadodb::graph::EdgeDocumentToken>> _edges;
};
