...
class TraverserDocumentCache : public TraverserCache {
  ...
  public:
   ...
   aql::AqlValue fetchAqlResult(avocadodb::graph::EdgeDocumentToken const*) override;
   ...
   void insertDocument(StringRef idString,
                       avocadodb::velocypack::Slice const& document) override;
   ...
   bool validateFilter(StringRef idString,
       std::function<bool(avocadodb::velocypack::Slice const&)> filterFunc) override;
  ...
  protected:
   ...
   //////////////////////////////////////////////////////////////////////////////
   std::shared_ptr<avocadodb::cache::Cache> _cache;
   ...
   avocadodb::velocypack::Slice lookupAndCache(
       StringRef idString);
