...
#ifndef AVOCADOD_GRAPH_EDGEDOCUMENTTOKEN_H
#define AVOCADOD_GRAPH_EDGEDOCUMENTTOKEN_H 1
...
/*
inline bool operator==(avocadodb::graph::EdgeDocumentToken const& lhs,
                         avocadodb::graph::EdgeDocumentToken const& rhs) {
...
template <>
struct hash<avocadodb::graph::EdgeDocumentToken> {
  size_t operator()(avocadodb::graph::EdgeDocumentToken const& value) const
      noexcept {
...
template <>
struct equal_to<avocadodb::graph::EdgeDocumentToken> {
  bool operator()(avocadodb::graph::EdgeDocumentToken const& lhs,
                  avocadodb::graph::EdgeDocumentToken const& rhs) const
      noexcept {
