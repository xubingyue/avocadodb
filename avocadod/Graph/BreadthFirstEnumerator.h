...
class BreadthFirstEnumerator final
    : public avocadodb::traverser::PathEnumerator {
 private:
  //////////////////////////////////////////////////////////////////////////////
  ...
  struct PathStep {
    ...
    avocadodb::StringRef const vertex;

   public:
    explicit PathStep(avocadodb::StringRef const vertex);
 ...
 public:
  BreadthFirstEnumerator(avocadodb::traverser::Traverser* traverser,
                         avocadodb::velocypack::Slice startVertex,
