...
struct BaseOptions {
 protected:
  struct LookupInfo {
    ...
    LookupInfo(avocadodb::aql::Query*, avocadodb::velocypack::Slice const&,
 ...
 public:
  static std::unique_ptr<BaseOptions> createOptionsFromSlice(
      transaction::Methods* trx, avocadodb::velocypack::Slice const& definition);
  ...
  BaseOptions(avocadodb::aql::Query*, avocadodb::velocypack::Slice,
  ...
  virtual void buildEngineInfo(avocadodb::velocypack::Builder&) const;
  ...
  void serializeVariables(avocadodb::velocypack::Builder&) const;
  ...
  // in the given builder.
  virtual void toVelocyPackIndexes(avocadodb::velocypack::Builder&) const;
 ...
 protected:
  ...
  void injectVelocyPackIndexes(avocadodb::velocypack::Builder&) const;

  // Requires an open Object in the given builder an
  // will inject EngineInfo into it.
  // Does not close the builder.
  void injectEngineInfo(avocadodb::velocypack::Builder&) const;

  aql::Expression* getEdgeExpression(size_t cursorId, bool& needToInjectVertex) const;

  bool evaluateExpression(aql::Expression*,
                          avocadodb::velocypack::Slice varValue) const;
