...
RemoteNode::RemoteNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
...
GatherNode::GatherNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base,
