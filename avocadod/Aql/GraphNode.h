...
class GraphNode : public ExecutionNode {
 public:
  ...
  GraphNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base);
 ...
 public:
  ...
  void toVelocyPackHelper(avocadodb::velocypack::Builder& nodes,
                          bool verbose) const;
  ...
  void enhanceEngineInfo(avocadodb::velocypack::Builder&) const;
 ...
 protected:
  ...
  avocadodb::velocypack::Builder _graphInfo;
