...
#ifndef AVOCADOD_AQL_CLUSTER_NODES_H
#define AVOCADOD_AQL_CLUSTER_NODES_H 1
...
class RemoteNode : public ExecutionNode {
 ...
 public:
  ...
  RemoteNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
  ...
  void queryId(QueryId queryId) {
    _queryId = avocadodb::basics::StringUtils::itoa(queryId);
  }
...
class ScatterNode : public ExecutionNode {
 ...
 public:
  ...
  ScatterNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class DistributeNode : public ExecutionNode {
 ...
 public:
  ...
  DistributeNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class GatherNode : public ExecutionNode {
 ...
 public:
  ...
  GatherNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base,
