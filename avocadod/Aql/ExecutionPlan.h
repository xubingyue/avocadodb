...
class ExecutionPlan {
 ...
 public:
  ...
  static ExecutionPlan* instantiateFromVelocyPack(
      Ast* ast, avocadodb::velocypack::Slice const);
  ...
  std::shared_ptr<avocadodb::velocypack::Builder> toVelocyPack(Ast*, bool verbose) const;
  
  void toVelocyPack(avocadodb::velocypack::Builder&, Ast*, bool verbose) const;
