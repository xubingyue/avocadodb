...
#ifndef AVOCADOD_AQL_EXPRESSION_H
#define AVOCADOD_AQL_EXPRESSION_H 1
...
class Expression {
 public:
  ...
  Expression(Ast*, avocadodb::velocypack::Slice const&);
  ...
  void toVelocyPack(avocadodb::velocypack::Builder& builder, bool verbose) const {
  ...
  void setVariable(Variable const* variable, avocadodb::velocypack::Slice value) {
 ...
 private:
  ...
  std::unordered_map<Variable const*, avocadodb::velocypack::Slice> _variables;
