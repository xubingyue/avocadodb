...
EnumerateCollectionNode::EnumerateCollectionNode(
    ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
...
LimitNode::LimitNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
    : ExecutionNode(plan, base),
...
FilterNode::FilterNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
    : ExecutionNode(plan, base),
      _inVariable(Variable::varFromVPack(plan->getAst(), base, "inVariable")) {}
...
ReturnNode::ReturnNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
    : ExecutionNode(plan, base),
      _inVariable(Variable::varFromVPack(plan->getAst(), base, "inVariable")) {}
