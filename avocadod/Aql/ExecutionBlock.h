...
#ifndef AVOCADOD_AQL_EXECUTION_BLOCK_H
#define AVOCADOD_AQL_EXECUTION_BLOCK_H 1
...
#define DEBUG_END_BLOCK()                                                     \
    ...
    LOG_TOPIC(WARN, avocadodb::Logger::FIXME) << "avocado exception caught in " << __FILE__ << ":" << __LINE__ \
              << ":" << ex.what();                                            \
    throw;                                                                    \
  }                                                                           \
  catch (std::exception const& ex) {                                          \
    LOG_TOPIC(WARN, avocadodb::Logger::FIXME) << "std exception caught in " << __FILE__ << ":" << __LINE__    \
              << ": " << ex.what();                                           \
    throw;                                                                    \
  }                                                                           \
  catch (...) {                                                               \
    LOG_TOPIC(WARN, avocadodb::Logger::FIXME) << "exception caught in " << __FILE__ << ":" << __LINE__;       \
    throw;                                                                    \
  }  //
