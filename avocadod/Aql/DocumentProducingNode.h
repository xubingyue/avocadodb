...
#ifndef AVOCADOD_AQL_DOCUMENT_PRODUCING_NODE_H
#define AVOCADOD_AQL_DOCUMENT_PRODUCING_NODE_H 1
...
class DocumentProducingNode {
 public:
  ...
  DocumentProducingNode(ExecutionPlan* plan, avocadodb::velocypack::Slice slice);
