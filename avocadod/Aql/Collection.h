...
#ifndef AVOCADOD_AQL_COLLECTION_H
#define AVOCADOD_AQL_COLLECTION_H 1
...
struct Collection {
  ...
  void setCollection(avocadodb::LogicalCollection* coll);

  /// @brief either use the set collection or get one from ClusterInfo:
  std::shared_ptr<avocadodb::LogicalCollection> getCollection() const;
