...
///
/// @file avocadod/Aql/TraversalNode.cpp
///
/// DISCLAIMER
///
...
TraversalNode::TraversalEdgeConditionBuilder::TraversalEdgeConditionBuilder(
    TraversalNode const* tn, avocadodb::velocypack::Slice const& condition)
...
void TraversalNode::toVelocyPackHelper(avocadodb::velocypack::Builder& nodes,
                                       bool verbose) const {
...
void TraversalNode::setCondition(avocadodb::aql::Condition* condition) {
