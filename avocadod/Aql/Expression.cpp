...
static void RegisterWarning(avocadodb::aql::Ast const* ast,
...
Expression::Expression(Ast* ast, avocadodb::velocypack::Slice const& slice)
...
bool Expression::isReference() const {
  return (_node->type == avocadodb::aql::NODE_TYPE_REFERENCE);
}
...
void Expression::stringify(avocadodb::basics::StringBuffer* buffer) const {
...
void Expression::stringifyIfNotTooLong(
    avocadodb::basics::StringBuffer* buffer) const {
