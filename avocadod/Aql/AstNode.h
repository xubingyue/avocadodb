...
struct AstNode {
  ...
  AstNode(Ast*, avocadodb::velocypack::Slice const& slice);
...
/// @brief dump the node (for debugging purposes)
  ...
  avocadodb::velocypack::Slice computeValue() const;
  ...
  static AstNodeType getNodeTypeFromVPack(avocadodb::velocypack::Slice const& slice);

  /// @brief return a VelocyPack representation of the node value
  std::shared_ptr<avocadodb::velocypack::Builder> toVelocyPackValue() const;

  /// @brief build a VelocyPack representation of the node value
  ///        Can throw Out of Memory Error
  void toVelocyPackValue(avocadodb::velocypack::Builder&) const;

  /// @brief return a VelocyPack representation of the node
  std::shared_ptr<avocadodb::velocypack::Builder> toVelocyPack(bool) const;

  /// @brief Create a VelocyPack representation of the node
  void toVelocyPack(avocadodb::velocypack::Builder&, bool) const;
  ...
  /// catching the error
  void stringify(avocadodb::basics::StringBuffer*, bool, bool) const;
  ...
  void appendValue(avocadodb::basics::StringBuffer*) const;
...
std::ostream& operator<<(std::ostream&, avocadodb::aql::AstNode const*);
std::ostream& operator<<(std::ostream&, avocadodb::aql::AstNode const&);
