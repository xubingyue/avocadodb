...
#ifndef AVOCADOD_AQL_DOCUMENT_PRODUCING_BLOCK_H
#define AVOCADOD_AQL_DOCUMENT_PRODUCING_BLOCK_H 1
...
class DocumentProducingBlock {
 public:
  typedef std::function<void(AqlItemBlock*, avocadodb::velocypack::Slice, size_t, size_t&, size_t)> DocumentProducingFunction;
