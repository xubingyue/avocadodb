...
#ifndef AVOCADOD_AQL_SORT_NODE_H
#define AVOCADOD_AQL_SORT_NODE_H 1
...
class SortNode : public ExecutionNode {
 ...
 public:
  ...
  SortNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base,
  ...
  SortInformation getSortInformation(ExecutionPlan*,
                                     avocadodb::basics::StringBuffer*) const;
