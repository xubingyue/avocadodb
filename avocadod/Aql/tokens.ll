...
#define YY_EXTRA_TYPE avocadodb::aql::Parser*
...
(0|[1-9][0-9]*) {  
  ...
  avocadodb::aql::AstNode* node = nullptr;
  auto parser = yyextra;

  try {
    int64_t value1 = avocadodb::basics::StringUtils::int64_check(std::string(yytext, yyleng));
