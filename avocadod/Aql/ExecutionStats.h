...
#ifndef AVOCADOD_AQL_EXECUTION_STATS_H
#define AVOCADOD_AQL_EXECUTION_STATS_H 1
...
struct ExecutionStats {
  ...
  explicit ExecutionStats(avocadodb::velocypack::Slice const& slice);
  ...
  static void toVelocyPackStatic(avocadodb::velocypack::Builder&);
