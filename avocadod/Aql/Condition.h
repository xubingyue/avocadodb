...
class Condition {
 ...
 public:
  ...
  static Condition* fromVPack(ExecutionPlan*, avocadodb::velocypack::Slice const&);
  ...
  std::vector<std::vector<avocadodb::basics::AttributeName>> getConstAttributes (Variable const*, bool);
 ...
 private:
  ...
  void storeAttributeAccess(
      std::pair<Variable const*, std::vector<avocadodb::basics::AttributeName>>& varAccess,
