...
#ifndef AVOCADOD_AQL_GRAPHS_H
#define AVOCADOD_AQL_GRAPHS_H 1
...
class Graph {
 public:
  explicit Graph(avocadodb::velocypack::Slice const&);
 ...
 public:
  ...
  void insertVertexCollections(avocadodb::velocypack::Slice& arr);
 ...
 public:
  ...
  virtual void enhanceEngineInfo(avocadodb::velocypack::Builder&) const;
};
