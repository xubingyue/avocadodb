...
class ExecutionNode {
 ...
 public:
  ...
  ExecutionNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& slice);
 ...
 public:
  ...
  void toVelocyPack(avocadodb::velocypack::Builder&, bool, bool = false) const;

  /// @brief toVelocyPack
  virtual void toVelocyPackHelper(avocadodb::velocypack::Builder&,
                                  bool) const = 0;
 ...
 protected:
  ...
  void toVelocyPackHelperGeneric(avocadodb::velocypack::Builder&, bool) const;
...
class SingletonNode : public ExecutionNode {
 ...
 public:
  ...
  SingletonNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
  ...
  void toVelocyPackHelper(avocadodb::velocypack::Builder&,
...
class EnumerateCollectionNode : public ExecutionNode, public DocumentProducingNode {
 ...
 public:
  ...
  EnumerateCollectionNode(ExecutionPlan* plan,
                          avocadodb::velocypack::Slice const& base);
...
class EnumerateListNode : public ExecutionNode {
 ...
 public:
  ...
  EnumerateListNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class LimitNode : public ExecutionNode {
 ...
 public:
  ...
  LimitNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class CalculationNode : public ExecutionNode {
 ...
 public:
  ...
  CalculationNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class SubqueryNode : public ExecutionNode {
 ...
 public:
  SubqueryNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class FilterNode : public ExecutionNode {
 ...
 public:
  ...
  FilterNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class ReturnNode : public ExecutionNode {
 ...
 public:
  ...
  ReturnNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class NoResultsNode : public ExecutionNode {
 ...
 public:
  ...
  NoResultsNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
      : ExecutionNode(plan, base) {}
