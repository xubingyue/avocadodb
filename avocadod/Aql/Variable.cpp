...
Variable::Variable(avocadodb::velocypack::Slice const& slice)
    : Variable(avocadodb::basics::VelocyPackHelper::checkAndGetStringValue(
                   slice, "name"),
               avocadodb::basics::VelocyPackHelper::checkAndGetNumericValue<
                   VariableId>(slice, "id")) {}
