...
RemoveNode::RemoveNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
...
InsertNode::InsertNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
    : ModificationNode(plan, base),
      _inVariable(Variable::varFromVPack(plan->getAst(), base, "inVariable")) {}
...
UpdateNode::UpdateNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
    : ModificationNode(plan, base),
...
UpsertNode::UpsertNode(ExecutionPlan* plan, avocadodb::velocypack::Slice const& base)
    : ModificationNode(plan, base),
      _inDocVariable(Variable::varFromVPack(plan->getAst(), base, "inDocVariable")),
