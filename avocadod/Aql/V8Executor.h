...
#ifndef AVOCADOD_AQL_V8EXECUTOR_H
#define AVOCADOD_AQL_V8EXECUTOR_H 1
...
class V8Executor {
 ...
 public:
  ...
  int executeExpression(Query*, AstNode const*, avocadodb::velocypack::Builder&);
  ...
  static void HandleV8Error(v8::TryCatch&, v8::Handle<v8::Value>&, avocadodb::basics::StringBuffer* const, bool duringCompile);
 ...
 private:
  ...
  avocadodb::basics::StringBuffer* initializeBuffer();

 private:
  /// @brief a string buffer used for operations
  avocadodb::basics::StringBuffer* _buffer;
