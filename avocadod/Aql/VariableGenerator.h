...
#ifndef AVOCADOD_AQL_VARIABLE_GENERATOR_H
#define AVOCADOD_AQL_VARIABLE_GENERATOR_H 1
...
class VariableGenerator {
 ...
 public:
  ...
  Variable* createVariable(avocadodb::velocypack::Slice const);
  ...
  void fromVelocyPack(avocadodb::velocypack::Slice const& allVariablesList);
