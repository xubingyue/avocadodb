...
%locations 
%defines
%parse-param { avocadodb::aql::Parser* parser }
...
reference:
    T_STRING {
      ...
      if (node == nullptr) {
        ...
        node = ast->createNodeCollection($1.value, avocadodb::AccessMode::Type::READ);
      }
...
collection_name:
    T_STRING {
      $$ = parser->ast()->createNodeCollection($1.value, avocadodb::AccessMode::Type::WRITE);
    }
  | T_QUOTED_STRING {
      $$ = parser->ast()->createNodeCollection($1.value, avocadodb::AccessMode::Type::WRITE);
    }
