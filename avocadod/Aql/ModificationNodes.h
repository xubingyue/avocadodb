...
#ifndef AVOCADOD_AQL_MODIFICATION_NODES_H
#define AVOCADOD_AQL_MODIFICATION_NODES_H 1
...
class ModificationNode : public ExecutionNode {
 ...
 protected:
  ...
  ModificationNode(ExecutionPlan*, avocadodb::velocypack::Slice const& slice);
...
class RemoveNode : public ModificationNode {
 ...
 public:
  ...
  RemoveNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class InsertNode : public ModificationNode {
 ...
 public:
  ...
  InsertNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class UpdateNode : public ModificationNode {
 ...
 public:
  ...
  UpdateNode(ExecutionPlan*, avocadodb::velocypack::Slice const&);
...
class ReplaceNode : public ModificationNode {
 ...
 public:
  ...
  ReplaceNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
...
class UpsertNode : public ModificationNode {
 ...
 public:
  ...
  UpsertNode(ExecutionPlan*, avocadodb::velocypack::Slice const& base);
