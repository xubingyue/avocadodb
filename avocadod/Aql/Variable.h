...
#ifndef AVOCADOD_AQL_VARIABLE_H
#define AVOCADOD_AQL_VARIABLE_H 1
...
struct Variable {
  ...
  explicit Variable(avocadodb::velocypack::Slice const&);
  ...
  static Variable* varFromVPack(Ast* ast, avocadodb::velocypack::Slice const& base,
