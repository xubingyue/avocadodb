...
#ifndef AVOCADOD_AQL_QUERY_CACHE_H
#define AVOCADOD_AQL_QUERY_CACHE_H 1
...
struct QueryCacheResultEntry {
  ...
  QueryCacheResultEntry(uint64_t, QueryString const&, std::shared_ptr<avocadodb::velocypack::Builder>,
  ...
  std::shared_ptr<avocadodb::velocypack::Builder> _queryResult;
...
class QueryCache {
 ...
 public:
  ...
  avocadodb::velocypack::Builder properties();
 ...
 private:
  ...
  avocadodb::Mutex _propertiesLock;

  /// @brief read-write lock for the cache
  avocadodb::basics::ReadWriteLock _entriesLock[NumberOfParts];
