...
#ifndef AVOCADOD_AQL_QUERY_H
#define AVOCADOD_AQL_QUERY_H 1
...
class Query {
 ...
 public:
  Query(bool contextOwnedByExterior, TRI_vocbase_t*, QueryString const& queryString,
        std::shared_ptr<avocadodb::velocypack::Builder> const& bindParameters,
        std::shared_ptr<avocadodb::velocypack::Builder> const& options, QueryPart);

  Query(bool contextOwnedByExterior, TRI_vocbase_t*,
        std::shared_ptr<avocadodb::velocypack::Builder> const& queryStruct,
        std::shared_ptr<avocadodb::velocypack::Builder> const& options, QueryPart);
 ...
 public:
  ...
  void getStats(avocadodb::velocypack::Builder&);
  ...
  void addWarningsToVelocyPackObject(avocadodb::velocypack::Builder&) const;

  /// @brief transform the list of warnings to VelocyPack.
  ///        NOTE: returns nullptr if there are no warnings.
  std::shared_ptr<avocadodb::velocypack::Builder> warningsToVelocyPack() const;
  ...
  std::shared_ptr<avocadodb::velocypack::Builder> bindParameters() const { 
 ...
 private:
  ...
  std::shared_ptr<avocadodb::velocypack::Builder> const _queryBuilder;

  /// @brief bind parameters for the query
  BindParameters _bindParameters;

  /// @brief query options
  std::shared_ptr<avocadodb::velocypack::Builder> _options;
