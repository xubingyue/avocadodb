...
#ifndef AVOCADODB_PREGEL_GRAPH_FORMAT_H
#define AVOCADODB_PREGEL_GRAPH_FORMAT_H 1
...
struct GraphFormat {
  ...
  virtual size_t copyVertexData(std::string const& documentId,
                                avocadodb::velocypack::Slice document,
                                V* targetPtr, size_t maxSize) = 0;
  virtual size_t copyEdgeData(avocadodb::velocypack::Slice edgeDocument,
                              E* targetPtr, size_t maxSize) = 0;

  virtual bool buildVertexDocument(avocadodb::velocypack::Builder& b,
                                   const V* targetPtr, size_t size) const = 0;
  virtual bool buildEdgeDocument(avocadodb::velocypack::Builder& b,
...
class NumberGraphFormat : public GraphFormat<V, E> {
 ...
 public:
  ...
  size_t copyVertexData(std::string const& documentId,
                        avocadodb::velocypack::Slice document, V* targetPtr,
                        size_t maxSize) override {
    avocadodb::velocypack::Slice val = document.get(_sourceField);
  ...
  size_t copyEdgeData(avocadodb::velocypack::Slice document, E* targetPtr,
                      size_t maxSize) override {
    avocadodb::velocypack::Slice val = document.get(_sourceField);
  ...
  bool buildVertexDocument(avocadodb::velocypack::Builder& b, const V* ptr,
                           size_t size) const override {
    b.add(_resultField, VPackValue(*ptr));
    return true;
  }

  bool buildEdgeDocument(avocadodb::velocypack::Builder& b, const E* ptr,
                         size_t size) const override {
    b.add(_resultField, VPackValue(*ptr));
    return true;
  }
...
class InitGraphFormat : public GraphFormat<V, E> {
 ...
 public:
  ...
  virtual size_t copyEdgeData(avocadodb::velocypack::Slice document,
  ...
  virtual bool buildVertexDocument(avocadodb::velocypack::Builder& b,
    ...
    b.add(_resultField, avocadodb::velocypack::Value(*ptr));
    return true;
  }

  virtual bool buildEdgeDocument(avocadodb::velocypack::Builder& b, const E* ptr,
                                 size_t size) const override {
    b.add(_resultField, avocadodb::velocypack::Value(*ptr));
    return true;
  }
...
class VertexGraphFormat : public GraphFormat<V, E> {
 ...
 public:
  ...
  size_t copyEdgeData(avocadodb::velocypack::Slice document, V* targetPtr,
                      size_t maxSize) override {
    return 0;
  }
