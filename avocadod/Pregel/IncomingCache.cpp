...
template class avocadodb::pregel::InCache<int64_t>;
template class avocadodb::pregel::InCache<uint64_t>;
template class avocadodb::pregel::InCache<float>;
template class avocadodb::pregel::InCache<double>;
template class avocadodb::pregel::ArrayInCache<int64_t>;
template class avocadodb::pregel::ArrayInCache<uint64_t>;
template class avocadodb::pregel::ArrayInCache<float>;
template class avocadodb::pregel::ArrayInCache<double>;
template class avocadodb::pregel::CombiningInCache<int64_t>;
template class avocadodb::pregel::CombiningInCache<uint64_t>;
template class avocadodb::pregel::CombiningInCache<float>;
template class avocadodb::pregel::CombiningInCache<double>;

// algo specific
template class avocadodb::pregel::InCache<SenderMessage<uint64_t>>;
template class avocadodb::pregel::ArrayInCache<SenderMessage<uint64_t>>;
template class avocadodb::pregel::CombiningInCache<SenderMessage<uint64_t>>;
template class avocadodb::pregel::InCache<SenderMessage<double>>;
template class avocadodb::pregel::ArrayInCache<SenderMessage<double>>;
template class avocadodb::pregel::CombiningInCache<SenderMessage<double>>;
template class avocadodb::pregel::InCache<DMIDMessage>;
template class avocadodb::pregel::ArrayInCache<DMIDMessage>;
template class avocadodb::pregel::CombiningInCache<DMIDMessage>;
template class avocadodb::pregel::InCache<HLLCounter>;
template class avocadodb::pregel::ArrayInCache<HLLCounter>;
template class avocadodb::pregel::CombiningInCache<HLLCounter>;
