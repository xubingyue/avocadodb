...
#ifndef AVOCADODB_PREGEL_ALGOS_RECO_PAGERANK_H
#define AVOCADODB_PREGEL_ALGOS_RECO_PAGERANK_H 1
...
struct RecoveringPageRank : public SimpleAlgorithm<float, float, float> {
  explicit RecoveringPageRank(avocadodb::velocypack::Slice params)
