...
template class avocadodb::pregel::OutCache<int64_t>;
template class avocadodb::pregel::OutCache<uint64_t>;
template class avocadodb::pregel::OutCache<float>;
template class avocadodb::pregel::OutCache<double>;
template class avocadodb::pregel::ArrayOutCache<int64_t>;
template class avocadodb::pregel::ArrayOutCache<uint64_t>;
template class avocadodb::pregel::ArrayOutCache<float>;
template class avocadodb::pregel::ArrayOutCache<double>;
template class avocadodb::pregel::CombiningOutCache<int64_t>;
template class avocadodb::pregel::CombiningOutCache<uint64_t>;
template class avocadodb::pregel::CombiningOutCache<float>;
template class avocadodb::pregel::CombiningOutCache<double>;

// algo specific
template class avocadodb::pregel::OutCache<SenderMessage<uint64_t>>;
template class avocadodb::pregel::ArrayOutCache<SenderMessage<uint64_t>>;
template class avocadodb::pregel::CombiningOutCache<SenderMessage<uint64_t>>;
template class avocadodb::pregel::OutCache<SenderMessage<double>>;
template class avocadodb::pregel::ArrayOutCache<SenderMessage<double>>;
template class avocadodb::pregel::CombiningOutCache<SenderMessage<double>>;
template class avocadodb::pregel::OutCache<DMIDMessage>;
template class avocadodb::pregel::ArrayOutCache<DMIDMessage>;
template class avocadodb::pregel::CombiningOutCache<DMIDMessage>;
template class avocadodb::pregel::OutCache<HLLCounter>;
template class avocadodb::pregel::ArrayOutCache<HLLCounter>;
template class avocadodb::pregel::CombiningOutCache<HLLCounter>;
