...
#define MY_READ_LOCKER(obj, lock)                                              \
  ReadLocker<ReadWriteLock> obj(&lock, avocadodb::basics::LockerType::BLOCKING, \
                                true, __FILE__, __LINE__)

#define MY_WRITE_LOCKER(obj, lock) \
  WriteLocker<ReadWriteLock> obj(  \
      &lock, avocadodb::basics::LockerType::BLOCKING, true, __FILE__, __LINE__)
...
template class avocadodb::pregel::Worker<int64_t, int64_t, int64_t>;
template class avocadodb::pregel::Worker<float, float, float>;
template class avocadodb::pregel::Worker<double, float, double>;
// custom algorihm types
template class avocadodb::pregel::Worker<SCCValue, int8_t,
                                        SenderMessage<uint64_t>>;
template class avocadodb::pregel::Worker<HITSValue, int8_t,
                                        SenderMessage<double>>;
template class avocadodb::pregel::Worker<ECValue, int8_t, HLLCounter>;
template class avocadodb::pregel::Worker<DMIDValue, float, DMIDMessage>;
template class avocadodb::pregel::Worker<LPValue, int8_t, uint64_t>;
template class avocadodb::pregel::Worker<SLPAValue, int8_t, uint64_t>;
