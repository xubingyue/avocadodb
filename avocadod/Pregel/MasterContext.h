...
#ifndef AVOCADODB_PREGEL_MASTER_CONTEXT_H
#define AVOCADODB_PREGEL_MASTER_CONTEXT_H 1
...
class MasterContext {
 ...
 public:
  ...
  inline void setAggregatedValue(std::string const& name, T const& value) {
    ...
    avocadodb::velocypack::Builder b;
    b.openObject();
    b.add("aggregators",
          avocadodb::velocypack::Value(avocadodb::velocypack::ValueType::Object));
    b.add(name, avocadodb::velocypack::Value(value));
    b.close();
    b.close();
