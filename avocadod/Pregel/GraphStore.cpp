...
template class avocadodb::pregel::GraphStore<int64_t, int64_t>;
template class avocadodb::pregel::GraphStore<float, float>;
template class avocadodb::pregel::GraphStore<double, float>;
template class avocadodb::pregel::GraphStore<double, double>;

// specific algo combos
template class avocadodb::pregel::GraphStore<SCCValue, int8_t>;
template class avocadodb::pregel::GraphStore<ECValue, int8_t>;
template class avocadodb::pregel::GraphStore<HITSValue, int8_t>;
template class avocadodb::pregel::GraphStore<DMIDValue, float>;
template class avocadodb::pregel::GraphStore<LPValue, int8_t>;
template class avocadodb::pregel::GraphStore<SLPAValue, int8_t>;
