...
#ifndef AVOCADODB_PREGEL_ALGORITHM_H
#define AVOCADODB_PREGEL_ALGORITHM_H 1
...
struct IAlgorithm {
  ...
  virtual MasterContext* masterContext(
      avocadodb::velocypack::Slice userParams) const {
    return nullptr;
  }
...
class SimpleAlgorithm : public Algorithm<V, E, M> {
 protected:
  ...
  SimpleAlgorithm(std::string const& name, VPackSlice userParams)
    ...
    avocadodb::velocypack::Slice field = userParams.get("sourceField");
