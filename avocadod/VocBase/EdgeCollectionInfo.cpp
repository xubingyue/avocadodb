...
std::unique_ptr<avocadodb::OperationCursor> EdgeCollectionInfo::getEdges(
    std::string const& vertexId,
    avocadodb::ManagedDocumentResult* mmdr) {
  _searchBuilder.setVertexId(vertexId);
  std::unique_ptr<avocadodb::OperationCursor> res;
  if (_dir == TRI_EDGE_OUT) {
...
std::unique_ptr<avocadodb::OperationCursor> EdgeCollectionInfo::getReverseEdges(
    std::string const& vertexId,
    avocadodb::ManagedDocumentResult* mmdr) {
  _searchBuilder.setVertexId(vertexId);
  std::unique_ptr<avocadodb::OperationCursor> res;
...
double EdgeCollectionInfo::weightEdge(VPackSlice const edge) {
  ...
  return avocadodb::basics::VelocyPackHelper::getNumericValue<double>(
