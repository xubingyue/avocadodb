...
avocadodb::Result LogicalView::updateProperties(VPackSlice const& slice,
                                               bool partialUpdate,
                                               bool doSync) {
...
void LogicalView::spawnImplementation(
    ViewCreator creator, avocadodb::velocypack::Slice const& parameters,
    bool isNew) {
