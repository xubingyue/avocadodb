...
#ifndef AVOCADOD_VOC_BASE_KEY_GENERATOR_H
#define AVOCADOD_VOC_BASE_KEY_GENERATOR_H 1
...
class KeyGenerator {
 ...
 public:
  ...
  static GeneratorType generatorType(avocadodb::velocypack::Slice const&);

  /// @brief create a key generator based on the options specified
  static KeyGenerator* factory(avocadodb::velocypack::Slice const&);
...
class TraditionalKeyGenerator final : public KeyGenerator {
 ...
 public:
  ...
  /// @brief build a VelocyPack representation of the generator in the builder
  virtual void toVelocyPack(avocadodb::velocypack::Builder&) const override;
