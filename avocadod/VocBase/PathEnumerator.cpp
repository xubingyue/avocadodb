...
using PathEnumerator = avocadodb::traverser::PathEnumerator;
using DepthFirstEnumerator = avocadodb::traverser::DepthFirstEnumerator;
using Traverser = avocadodb::traverser::Traverser;
using TraverserOptions = avocadodb::traverser::TraverserOptions;
...
avocadodb::aql::AqlValue DepthFirstEnumerator::lastVertexToAqlValue() {
  return _traverser->fetchVertexData(
      StringRef(_enumeratedPath.vertices.back()));
}

avocadodb::aql::AqlValue DepthFirstEnumerator::lastEdgeToAqlValue() {
  if (_enumeratedPath.edges.empty()) {
...
avocadodb::aql::AqlValue DepthFirstEnumerator::pathToAqlValue(
