...
avocadodb::Result Databases::info(TRI_vocbase_t* vocbase, VPackBuilder& result) {
  if (ServerState::instance()->isCoordinator()) {
    AgencyComm agency;
...
avocadodb::Result Databases::create(std::string const& dbName,
...
avocadodb::Result Databases::drop(TRI_vocbase_t* systemVocbase,
