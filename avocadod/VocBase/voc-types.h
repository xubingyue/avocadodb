...
template <>
struct hash<std::vector<avocadodb::velocypack::Slice>> {
  size_t operator()(std::vector<avocadodb::velocypack::Slice> const& x) const {
    std::hash<avocadodb::velocypack::Slice> sliceHash;
