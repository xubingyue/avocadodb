...
using VPackHelper = avocadodb::basics::VelocyPackHelper;
...
avocadodb::traverser::TraverserOptions::TraverserOptions(
    avocadodb::aql::Query* query, VPackSlice info, VPackSlice collections)
...
bool TraverserOptions::hasEdgeFilter(int64_t depth, size_t cursorId) const {
  ...
  avocadodb::aql::Expression* expression = nullptr;
...
bool TraverserOptions::evaluateEdgeExpression(avocadodb::velocypack::Slice edge,
                                              StringRef vertexId,
                                              uint64_t depth,
...
bool TraverserOptions::evaluateVertexExpression(
    avocadodb::velocypack::Slice vertex, uint64_t depth) const {
  avocadodb::aql::Expression* expression = nullptr;
...
EdgeCursor* avocadodb::traverser::TraverserOptions::nextCursor(
