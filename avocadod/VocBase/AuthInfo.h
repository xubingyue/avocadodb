...
class AuthInfo {
 ...
 public:
  ...
  /// Add user from avocadodb, do not use for LDAP  users
  ...
  AuthResult checkAuthentication(avocadodb::rest::AuthenticationMethod authType,
 ...
 private:
  ...
  std::unordered_map<std::string, avocadodb::AuthResult> _authBasicCache;
  avocadodb::basics::LruCache<std::string, avocadodb::AuthJwtResult>
      _authJwtCache;
