...
#ifndef AVOCADOD_VOCBASE_LOGICAL_VIEW_H
#define AVOCADOD_VOCBASE_LOGICAL_VIEW_H 1
...
class LogicalView {
 ...
 public:
  ...
  // Update this view.
  avocadodb::Result updateProperties(velocypack::Slice const&, bool, bool);
  ...
  void spawnImplementation(ViewCreator creator,
                           avocadodb::velocypack::Slice const& parameters,
                           bool isNew);
