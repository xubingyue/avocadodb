...
class Traverser {
  friend class avocadodb::graph::BreadthFirstEnumerator;
  friend class DepthFirstEnumerator;
  friend class avocadodb::graph::NeighborsEnumerator;
 ...
 protected:
  ...
  class VertexGetter {
   public:
    ...
    virtual bool getVertex(avocadodb::velocypack::Slice,
                           std::vector<avocadodb::StringRef>&);

    virtual bool getSingleVertex(avocadodb::velocypack::Slice, StringRef,
                                 uint64_t, StringRef&);

    virtual void reset(avocadodb::StringRef const&);
  ...
  class UniqueVertexGetter : public VertexGetter {
   public:
    ...
    bool getVertex(avocadodb::velocypack::Slice,
                   std::vector<avocadodb::StringRef>&) override;

    bool getSingleVertex(avocadodb::velocypack::Slice, StringRef,
                         uint64_t, StringRef&) override;

    void reset(avocadodb::StringRef const&) override;

   private:
    std::unordered_set<avocadodb::StringRef> _returnedVertices;
  };
 ...
 protected:
  ...
  virtual bool getVertex(avocadodb::velocypack::Slice,
                         std::vector<avocadodb::StringRef>&) = 0;

  /// @brief Function to load the other sides vertex of an edge
  ///        Returns true if the vertex passes filtering conditions
  virtual bool getSingleVertex(avocadodb::velocypack::Slice edge,
                               avocadodb::StringRef const sourceVertexId,
                               uint64_t depth,
                               avocadodb::StringRef& targetVertexId) = 0;
 ...
 public:
  ...
  aql::AqlValue pathToAqlValue(avocadodb::velocypack::Builder&);
  ...
  bool edgeMatchesConditions(avocadodb::velocypack::Slice edge, StringRef vid,
                             uint64_t depth, size_t cursorId);

  bool vertexMatchesConditions(avocadodb::velocypack::Slice, uint64_t);
 ...
 protected:
  ...
  std::unique_ptr<avocadodb::traverser::PathEnumerator> _enumerator;
