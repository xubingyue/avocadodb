...
#ifndef AVOCADOD_UTILS_OPERATION_OPTIONS_H
#define AVOCADOD_UTILS_OPERATION_OPTIONS_H 1
...
struct OperationOptions {
  ...
  // this option is there to ensure _key values once set can be restored by replicated and avocadorestore
  bool isRestore;
