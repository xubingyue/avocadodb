...
class Cursor {
 public:
  ...
  Cursor(CursorId, size_t, std::shared_ptr<avocadodb::velocypack::Builder>,
         double, bool);
 ...
 public:
  ...
  avocadodb::velocypack::Slice extra() const;
  ...
  virtual avocadodb::velocypack::Slice next() = 0;
 ...
 protected:
  ...
  size_t _position;
  std::shared_ptr<avocadodb::velocypack::Builder> const _extra;
  double _ttl;
  double _expires;
...
class VelocyPackCursor final : public Cursor {
 public:
  VelocyPackCursor(TRI_vocbase_t*, CursorId, aql::QueryResult&&, size_t,
                   std::shared_ptr<avocadodb::velocypack::Builder>, double,
                   bool);
