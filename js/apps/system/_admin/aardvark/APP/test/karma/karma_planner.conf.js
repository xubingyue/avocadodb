...
module.exports = function(karma) {
  ...
  karma.set({
    ...
    files: [
      ...
      'frontend/js/modules/@avocadodb/avocado-collection-common.js',
      'frontend/js/modules/@avocadodb/avocado-collection.js',
      'frontend/js/modules/@avocadodb/avocado-database.js',
      'frontend/js/modules/@avocadodb/avocado-query-cursor.js',
      'frontend/js/modules/@avocadodb/avocado-statement-common.js',
      'frontend/js/modules/@avocadodb/avocado-statement.js',
      'frontend/js/modules/@avocadodb/avocadosh.js',
      'frontend/js/modules/@avocadodb/graph-common.js',
      'frontend/js/modules/@avocadodb/graph.js',
      'frontend/js/modules/@avocadodb/mimetypes.js',
      'frontend/js/modules/@avocadodb/simple-query-common.js',
      'frontend/js/modules/@avocadodb/simple-query.js',
      'frontend/js/modules/@avocadodb/aql/functions.js',
      'frontend/js/modules/@avocadodb/graph/traversal.js',
      'frontend/js/modules/@avocadodb/common.js',
      'frontend/js/modules/@avocadodb/index.js',
      ...
      'frontend/js/graphViewer/graph/avocadoAdapter.js',
      ...
      'frontend/js/graphViewer/ui/avocadoAdapterControls.js',
      ...
      '../../frontend/js/models/avocadoCollectionModel.js',
      'frontend/js/models/avocadoDatabase.js',
      'frontend/js/models/avocadoDocument.js',
      'frontend/js/models/avocadoStatistics.js',
      'frontend/js/models/avocadoStatisticsDescription.js',
      ...
      // Collections
      'frontend/js/collections/avocadoCollections.js',
      'frontend/js/collections/avocadoDocuments.js',
      'frontend/js/collections/avocadoDocument.js',
      'frontend/js/collections/avocadoDatabase.js',
      'frontend/js/collections/avocadoSession.js',
      'frontend/js/collections/avocadoStatisticsCollection.js',
      'frontend/js/collections/avocadoStatisticsDescriptionCollection.js',
