...
(function () {
  ...
  describe('Avocado Adapter', function () {
    describeInterface(new AvocadoAdapter([], [], {}, {
      nodeCollection: '',
      edgeCollection: ''
    }));
    ...
    it('should throw an error if no nodeCollection or graph is given', function () {
      expect(
        function () {
          var t = new AvocadoAdapter([], [], viewer, {
            edgeCollection: ''
          });
        }
    ...
    it('should automatically determine the host of not given', function () {
      var adapter = new AvocadoAdapter(
          nodes,
          edges,
          viewer,
          {
