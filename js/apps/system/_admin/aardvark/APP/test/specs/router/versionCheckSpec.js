  ...
  describe('version check', function() {
    ...
    describe('showing the dialog', function() {
      ...
      beforeEach(function() {
        ...
        expect(window.versionHelper.fromString).toHaveBeenCalledWith(
          data.version);
      ...
      it('should not show a dialog if no new version is available',
        function() {
      ...
      describe('if dialog is allowed', function() {
        ...
        describe('buttons', function() {
          ...
          it('should create the never remind button',
            function() {
              window.parseVersions({
                major: {
                  version: '3.0.1'
        ...
        it('should offer a new major and bugfix', function() {
          ...
          expect(window.modalView.createReadOnlyEntry)
            .toHaveBeenCalledWith('current', 'Current',
              current);
          expect(window.modalView.createReadOnlyEntry)
          ...
          expect(window.modalView.createReadOnlyEntry).not
            .toHaveBeenCalledWith('minor', 'Minor', jasmine.any(
              String));
        });
        ...
        it('should offer a new minor', function() {
          ...
          expect(window.modalView.createReadOnlyEntry)
            .toHaveBeenCalledWith('current', 'Current',
              current);
          expect(window.modalView.createReadOnlyEntry).not
            .toHaveBeenCalledWith('major', 'Major', jasmine.any(
              String));
          expect(window.modalView.createReadOnlyEntry).not
            .toHaveBeenCalledWith('bugfix', 'Bugfix', jasmine
              .any(String));
          expect(window.modalView.createReadOnlyEntry)
