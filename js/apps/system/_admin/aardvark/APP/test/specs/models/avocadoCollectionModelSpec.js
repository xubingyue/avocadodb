/* jshint browser: true */
/* jshint unused: false */
/* global describe, beforeEach, afterEach, it, spyOn, expect, jasmine, window, $, avocadoHelper*/

(function () {
  'use strict';

  describe('Avocado Collection Model', function () {
    var myCollection;

    beforeEach(function () {
      myCollection = new window.avocadoCollectionModel();
    });
    ...
    describe('checking ajax', function () {
      ...
      describe('loadCollection', function () {
        ...
        it('fail', function () {
          ...
          myCollection.loadCollection();
          expect(avocadoHelper.avocadoError).toHaveBeenCalledWith('Collection error');
        });
      });
