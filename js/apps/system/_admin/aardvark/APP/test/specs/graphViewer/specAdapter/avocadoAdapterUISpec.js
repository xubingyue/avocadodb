...
(function () {
  ...
  describe('Avocado Adapter UI', function () {
    ...
    beforeEach(function () {
      ...
      adapterUI = new AvocadoAdapterControls(list, adapter);
    ...
    it('should throw errors if not setup correctly', function () {
      expect(function () {
        var e = new AvocadoAdapterControls();
      }).toThrow('A list element has to be given.');
      expect(function () {
        var e = new AvocadoAdapterControls(list);
      }).toThrow('The AvocadoAdapter has to be given.');
    });
