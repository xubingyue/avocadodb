...
function runThere (options, instanceInfo, file) {
  try {
    ...
    if (file.indexOf('-spec') === -1) {
      ...
      testCode = 'const runTest = require("@avocadodb/mocha-runner"); ' +
...
// //////////////////////////////////////////////////////////////////////////////
// / @brief runs a local unittest file using avocadosh
// //////////////////////////////////////////////////////////////////////////////

function runInAvocadosh (options, instanceInfo, file, addArgs) {
...
exports.runInAvocadosh = runInAvocadosh;
