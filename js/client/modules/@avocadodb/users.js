...
const avocadosh = require('@avocadodb/avocadosh');
...
exports.save = function (user, passwd, active, extra, changePassword) {
  ...
  return avocadosh.checkRequestResult(requestResult);
};
...
exports.isValid = function (user, password) {
  ...
  if (requestResult.error !== undefined && requestResult.error) {
    if (requestResult.errorNum === avocadodb.errors.ERROR_USER_NOT_FOUND.code) {
      return false;
    }
...
exports.all = function () {
  ...
  var requestResult = db._connection.GET(uri);
  return avocadosh.checkRequestResult(requestResult).result;
};
...
exports.currentUser = function() {
  return internal.avocado.connectedUser();
};
