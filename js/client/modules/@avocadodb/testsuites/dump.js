...
function dump (options) {
  ...
  if (pu.avocadod.check.instanceAlive(instanceInfo, options) &&
    ...
    results.dump = pu.run.avocadoDumpRestore(options, instanceInfo, 'dump',
      'UnitTestsDumpSrc');
    ...
    if (pu.avocadod.check.instanceAlive(instanceInfo, options) &&
      ...
      results.restore = pu.run.avocadoDumpRestore(options, instanceInfo, 'restore',
        'UnitTestsDumpDst');
      ...
      if (pu.avocadod.check.instanceAlive(instanceInfo, options) &&
        ...
        results.test = tu.runInAvocadosh(options, instanceInfo,
