...
function upgrade (options) {
  ...
  let args = pu.makeArgs.avocadod(options, appDir);
  ...
  result.upgrade.first = pu.executeAndWait(pu.AVOCADOD_BIN, argv, options, 'upgrade', tmpDataDir);
  ...
  result.upgrade.second = pu.executeAndWait(pu.AVOCADOD_BIN, argv, options, 'upgrade', tmpDataDir);
