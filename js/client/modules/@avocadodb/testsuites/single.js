...
const functionsDocumentation = {
  'single_client': 'run one test suite isolated via the avocadosh; options required\n' +
...
function singleClient (options) {
  ...
  if (options.test !== undefined) {
    ...
    print('\n' + Date() + ' avocadosh: Trying ', te, '...');

    let result = {};

    result[te] = tu.runInAvocadosh(options, instanceInfo, te);
