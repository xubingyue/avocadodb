...
var lessons = [
  {
    ...
    text: 'This is a user-interactive tutorial on AvocadoDB and the AvocadoDB shell.\n' +
      'It will give you a first look into AvocadoDB and how it works.'
  },
  {
  ...
  },
  {
    ...
    text: 'AvocadoDB is primarily a document database. This means that we store data as\n' +
  ...
  },
  {
    ...
    text: 'Now you can take a look at the collection(s) you just created:\n\n' +
      '  db._collections();\n\n' +
      "Please note that all collections will be returned, including AvocadoDB's\n" +
  ...
  },
  {
    ...
    text: 'AvocadoDB also provides a query language (AQL) for more complex matching:\n\n' +
      '  db._query(`\n' +
      '    FOR u IN users\n' +
      ...
      'https://docs.avocadodb.com/'
  },
  {
    title: 'Using Databases',
    text: 'By default, the AvocadoShell connects to the default database.\n' +
