...
// must be called after exporting AvocadoCollection
require('@avocadodb/avocado-collection-common');
...
AvocadoCollection.prototype._appendSyncParameter = function (url, waitForSync) {
  if (waitForSync) {
    if (url.indexOf('?') === -1) {
      url += '?';
    }else {
...
AvocadoCollection.prototype._appendBoolParameter = function (url, name, val) {
  if (url.indexOf('?') === -1) {
    url += '?';
  }else {
    url += '&';
...
AvocadoCollection.prototype._prefixurl = function (url) {
...
AvocadoCollection.prototype._baseurl = function (suffix) {
...
AvocadoCollection.prototype._documenturl = function (id) {
  var s = id.split('/'), url;
  var name = this.name();
  if (s.length === 1) {
...
AvocadoCollection.prototype._documentcollectionurl = function () {
...
AvocadoCollection.prototype._indexurl = function () {
...
AvocadoCollection.prototype._edgesQuery = function (vertex, direction) {
...
AvocadoCollection.prototype.shards = function () {
...
var helpAvocadoCollection = avocadosh.createHelpHeadline('AvocadoCollection help') +
...
AvocadoCollection.prototype._help = function () {
  internal.print(helpAvocadoCollection);
};
...
AvocadoCollection.prototype.status = function () {
  if (this._status === null || 
      this._status === AvocadoCollection.STATUS_UNLOADING || 
      this._status === AvocadoCollection.STATUS_UNLOADED) {
    this._status = null;
    this.refresh();
  }
  ...
  if (this._status === AvocadoCollection.STATUS_UNLOADING ||
      this._status === AvocadoCollection.STATUS_UNLOADED) {
...
AvocadoCollection.prototype.type = function () {
  if (this._type === null) {
    this.refresh();
  }
...
AvocadoCollection.prototype.rotate = function () {
...
AvocadoCollection.prototype.checksum = function (withRevisions, withData) {
  var append = '';
  if (withRevisions) {
...
AvocadoCollection.prototype.revision = function () {
...
AvocadoCollection.prototype.drop = function (options) {
  var requestResult;
...
AvocadoCollection.prototype.load = function (count) {
  var data = { count: true };
...
AvocadoCollection.prototype.getIndexes = function (withStats) {
...
AvocadoCollection.prototype.ensureIndex = function (data) {
...
AvocadoCollection.prototype.count = function (details) {
  var requestResult;
  if (details) {
...
AvocadoCollection.prototype.exists = function (id) {
  var rev = null;
  var requestResult;
...
AvocadoCollection.prototype.any = function () {
...
AvocadoCollection.prototype.firstExample = function (example) {
  var e;
  var i;
...
AvocadoCollection.prototype.save =
  AvocadoCollection.prototype.insert = function (from, to, data, options) {
    ...
    if (type === AvocadoCollection.TYPE_DOCUMENT || data === undefined) {
      data = from;
      options = to;
    }
...
AvocadoCollection.prototype.remove = function (id, overwrite, waitForSync) {
  var rev = null;
  var requestResult;
...
AvocadoCollection.prototype.replace = function (id, data, overwrite, waitForSync) {
  var rev = null;
  var requestResult;
...
AvocadoCollection.prototype.update = function (id, data, overwrite, keepNull, waitForSync) {
  var rev = null;
  var requestResult;
...
AvocadoCollection.prototype.edges = function (vertex) {
...
AvocadoCollection.prototype.inEdges = function (vertex) {
...
AvocadoCollection.prototype.outEdges = function (vertex) {
...
AvocadoCollection.prototype.removeByExample = function (example,
  waitForSync,
  limit) {
  var data = {
...
AvocadoCollection.prototype.replaceByExample = function (example,
  newValue,
  waitForSync,
  limit) {
  var data = {
...
AvocadoCollection.prototype.updateByExample = function (example,
  newValue,
  keepNull,
  waitForSync,
  limit) {
...
AvocadoCollection.prototype.documents = function (keys) {
  var data = {
    collection: this._name,
    keys: keys || []
  };
...
AvocadoCollection.prototype.lookupByKeys = AvocadoCollection.prototype.documents;

// //////////////////////////////////////////////////////////////////////////////
// / @brief removes documents by keys
// //////////////////////////////////////////////////////////////////////////////

AvocadoCollection.prototype.removeByKeys = function (keys) {
  var data = {
    collection: this._name,
    keys: keys || []
  };
...
AvocadoCollection.prototype.loadIndexesIntoMemory = function () {
  this._status = null;
