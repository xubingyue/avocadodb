...
(function () {
  ...
  internal.errors = {
    ...
    "ERROR_AVOCADO_READ_ONLY"       : { "code" : 1004, "message" : "read only" },
    "ERROR_AVOCADO_DUPLICATE_IDENTIFIER" : { "code" : 1005, "message" : "duplicate identifier" },
    "ERROR_AVOCADO_DATAFILE_UNREADABLE" : { "code" : 1006, "message" : "datafile unreadable" },
    "ERROR_AVOCADO_DATAFILE_EMPTY"  : { "code" : 1007, "message" : "datafile empty" },
    "ERROR_AVOCADO_RECOVERY"        : { "code" : 1008, "message" : "logfile recovery error" },
    "ERROR_AVOCADO_DATAFILE_STATISTICS_NOT_FOUND" : { "code" : 1009, "message" : "datafile statistics not found" },
    "ERROR_AVOCADO_CORRUPTED_DATAFILE" : { "code" : 1100, "message" : "corrupted datafile" },
    "ERROR_AVOCADO_ILLEGAL_PARAMETER_FILE" : { "code" : 1101, "message" : "illegal or unreadable parameter file" },
    ...
    "ERROR_AVOCADO_DATADIR_LOCKED"  : { "code" : 1107, "message" : "database directory is locked" },
    ...
    "ERROR_AVOCADO_MSYNC_FAILED"    : { "code" : 1109, "message" : "msync failed" },
    "ERROR_AVOCADO_DATADIR_UNLOCKABLE" : { "code" : 1110, "message" : "cannot lock database directory" },
    "ERROR_AVOCADO_SYNC_TIMEOUT"    : { "code" : 1111, "message" : "sync timeout" },
    "ERROR_AVOCADO_CONFLICT"        : { "code" : 1200, "message" : "conflict" },
    "ERROR_AVOCADO_DATADIR_INVALID" : { "code" : 1201, "message" : "invalid database directory" },
    ...
    "ERROR_AVOCADO_MAXIMAL_SIZE_TOO_SMALL" : { "code" : 1206, "message" : "maximal size of journal too small" },
    ...
    "ERROR_AVOCADO_VIEW_NOT_FOUND"  : { "code" : 1211, "message" : "view not found" },
    ...
    "ERROR_AVOCADO_DOCUMENT_TOO_LARGE" : { "code" : 1216, "message" : "document too large" },
    "ERROR_AVOCADO_COLLECTION_NOT_UNLOADED" : { "code" : 1217, "message" : "collection must be unloaded" },
    "ERROR_AVOCADO_COLLECTION_TYPE_INVALID" : { "code" : 1218, "message" : "collection type invalid" },
    "ERROR_AVOCADO_VALIDATION_FAILED" : { "code" : 1219, "message" : "validator failed" },
    "ERROR_AVOCADO_ATTRIBUTE_PARSER_FAILED" : { "code" : 1220, "message" : "parsing attribute name definition failed" },
    "ERROR_AVOCADO_DOCUMENT_KEY_BAD" : { "code" : 1221, "message" : "illegal document key" },
    "ERROR_AVOCADO_DOCUMENT_KEY_UNEXPECTED" : { "code" : 1222, "message" : "unexpected document key" },
    "ERROR_AVOCADO_DATADIR_NOT_WRITABLE" : { "code" : 1224, "message" : "server database directory not writable" },
    "ERROR_AVOCADO_OUT_OF_KEYS"     : { "code" : 1225, "message" : "out of keys" },
    "ERROR_AVOCADO_DOCUMENT_KEY_MISSING" : { "code" : 1226, "message" : "missing document key" },
    "ERROR_AVOCADO_DOCUMENT_TYPE_INVALID" : { "code" : 1227, "message" : "invalid document type" },
    "ERROR_AVOCADO_DATABASE_NOT_FOUND" : { "code" : 1228, "message" : "database not found" },
    "ERROR_AVOCADO_DATABASE_NAME_INVALID" : { "code" : 1229, "message" : "database name invalid" },
    "ERROR_AVOCADO_USE_SYSTEM_DATABASE" : { "code" : 1230, "message" : "operation only allowed in system database" },
    "ERROR_AVOCADO_ENDPOINT_NOT_FOUND" : { "code" : 1231, "message" : "endpoint not found" },
    "ERROR_AVOCADO_INVALID_KEY_GENERATOR" : { "code" : 1232, "message" : "invalid key generator" },
    "ERROR_AVOCADO_INVALID_EDGE_ATTRIBUTE" : { "code" : 1233, "message" : "edge attribute missing or invalid" },
    "ERROR_AVOCADO_INDEX_DOCUMENT_ATTRIBUTE_MISSING" : { "code" : 1234, "message" : "index insertion warning - attribute missing in document" },
    "ERROR_AVOCADO_INDEX_CREATION_FAILED" : { "code" : 1235, "message" : "index creation failed" },
    "ERROR_AVOCADO_WRITE_THROTTLE_TIMEOUT" : { "code" : 1236, "message" : "write-throttling timeout" },
    "ERROR_AVOCADO_COLLECTION_TYPE_MISMATCH" : { "code" : 1237, "message" : "collection type mismatch" },
    "ERROR_AVOCADO_COLLECTION_NOT_LOADED" : { "code" : 1238, "message" : "collection not loaded" },
    "ERROR_AVOCADO_DOCUMENT_REV_BAD" : { "code" : 1239, "message" : "illegal document revision" },
    "ERROR_AVOCADO_DATAFILE_FULL"   : { "code" : 1300, "message" : "datafile full" },
    "ERROR_AVOCADO_EMPTY_DATADIR"   : { "code" : 1301, "message" : "server database directory is empty" },
    "ERROR_AVOCADO_TRY_AGAIN"       : { "code" : 1302, "message" : "operation should be tried again" },
    "ERROR_AVOCADO_BUSY"            : { "code" : 1303, "message" : "engine is busy" },
    "ERROR_AVOCADO_MERGE_IN_PROGRESS" : { "code" : 1304, "message" : "merge in progress" },
    "ERROR_AVOCADO_IO_ERROR"        : { "code" : 1305, "message" : "storage engine I/O error" },
    ...
    "ERROR_AVOCADO_DOCUMENT_NOT_FOUND_OR_SHARDING_ATTRIBUTES_CHANGED" : { "code" : 1475, "message" : "document not found or sharding attributes changed" },
    ...
    "ERROR_GRAPH_NOT_AN_AVOCADO_COLLECTION" : { "code" : 1931, "message" : " is not an AvocadoCollection" },
