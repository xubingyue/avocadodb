...
var crypto = require("@avocadodb/crypto");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testMd5 : function () {
      var data = [
        ...
        [ "avocadodb", "335889e69e03cefd041babef1b02a0b8" ],
        [ "Avocadodb", "0862bc79ec789143f75e3282df98c8f4" ],
        [ "AvocadoDB is a database", "b88ddc26cfa3a652fdd8bf8e8c069540" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSha512 : function () {
      var data = [
        ...
        [ "avocadodb", "87509a178c07ce9f75bf70042297e414fded142109644781774bee3a5634ef0986de9806b9a63e18353037ef9fc04c6fc0cab2b12eff5d081e0a9d4d8412c4eb" ],
        [ "Avocadodb", "fb4d3ac6ccf6ac32751943ae10aa4cb86e1495042898e2d24fae79220f9421d94394db3be05a5e5f92b4ffe7ca4356bff56aa3eee0e68365e77245ebb6c34fb5" ],
        [ "AvocadoDB is a database", "b6a1ca6cdc7d8085ceda20a5b78251787df5f959daa36929f6bc6bb517dd9adc5d1610f43443151d14294ece1885e5560c12ca44d10e430d0208ca4bc481ebbd" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSha384 : function () {
      var data = [
        ...
        [ "avocadodb", "d2b5ff08b3784080520f11535243c2314e3f9ef42335d8e80d17cb8b002626d9833d9cd68c50b0b5aea8f2c111fb95dd" ],
        [ "Avocadodb", "643d99c8edd96d48075161ad92f541bdd6d77460c1b1fd14353abcc309155f84ca7c138df1b647db59c537afd7b80521" ],
        [ "AvocadoDB is a database", "579f8b2972baf5b0acb3b4db39afeebd7274b1a2083cd110a554df0b63cdc0cc757d1e8d771e51e71cfe2c2ac2617e93" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSha256 : function () {
      var data = [
        ...
        [ "avocadodb", "d0a274654772fa104df32ff457ff0a432f2dfad18e7c3146fab3c807f2ed86e5" ],
        [ "Avocadodb", "38579e73fd7435de7db93028a1b340be77445b46c94dff013c05c696ccae259c" ],
        [ "AvocadoDB is a database", "00231e8f9c0a617426ae51e4e230a1b25f6d5b82c10fccc835b514142f235f31" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSha224 : function () {
      var data = [
        ...
        [ "avocadodb", "deeb6d8f9b6c316e7f5a601fb2549a2ebc857bee78df38b1977c9989" ],
        [ "Avocadodb", "6d7a8a7fb22537dab437c8c2915874a170b2b14eb1aa787df32d6999" ],
        [ "AvocadoDB is a database", "9a3e02d47eb686c67f6b9a51efe16e8b4f88b0ee14248636d6163f1d" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSha1 : function () {
      var data = [
        ...
        [ "avocadodb", "1f9aa6577198dd5fcab487d08d45258608dac9b5" ],
        [ "Avocadodb", "5fc1b451c5cd4770df14bd3ae362b5587a195311" ],
        [ "AvocadoDB is a database", "9e45475b50ea3e8438c55919238aa5b0736bda43" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testHmac : function () {
      var data = [
        ...
        [ "secret", "avocadodb", "sha256", "85ae370b23a90d5f511a378678edc084f2a0d1190b96f1f543f7e0848a597a6d" ],
        [ "secret", "Avocadodb", "sha256", "95144e880bbc4a4bf10a2b683603c763a38817b544e1c2f6ff1bd3523bf60f9e" ],
        [ "secret", "AvocadoDB is a database", "sha256", "4888d586d3208ca18ebaf78569949a13f3c03585edb007771cd820820a351b0f" ],
        [ "SECRET", "AvocadoDB is a database", "sha256", "a04df5ce362f49439db5e30032b20e0fa64d01c60ceb32a9150e58d3c2c929af" ],
        [ "secret", "AvocadoDB is a database", "sha224", "b55c13e25227abf919b510cf2289f4501fa13584676e7e4d56108172" ],
        [ "secret", "AvocadoDB is a database", "SHA224", "b55c13e25227abf919b510cf2289f4501fa13584676e7e4d56108172" ],
        [ "secret", "AvocadoDB is a database", "sha384", "bb8da1979a964225996280d30c1ff73b1297145aaaa57520d4a1f38c648a85541f2d8e22f7e20dc3a556563e386521a7" ],
        [ "secret", "AvocadoDB is a database", "SHA384", "bb8da1979a964225996280d30c1ff73b1297145aaaa57520d4a1f38c648a85541f2d8e22f7e20dc3a556563e386521a7" ],
        [ "secret", "AvocadoDB is a database", "sha512", "8ef4e708db5bbc13ecf675ab81c9bfac72faedaf68fae91c51c0736746d087396af758a43cd60f763a5a8187d856c906c1677c7525b756cdb1ad5a7df823df73" ],
        [ "secret", "AvocadoDB is a database", "SHA512", "8ef4e708db5bbc13ecf675ab81c9bfac72faedaf68fae91c51c0736746d087396af758a43cd60f763a5a8187d856c906c1677c7525b756cdb1ad5a7df823df73" ],
        [ "secret", "AvocadoDB is a database", "sha1", "f39d7a76e502ba3f79d663cfbc9ac43eb6fd323e" ],
        [ "secret", "AvocadoDB is a database", "SHA1", "f39d7a76e502ba3f79d663cfbc9ac43eb6fd323e" ],
        [ "secret", "AvocadoDB is a database", "md5", "6eecfc947725974efc24bbaaafe15a13" ],
        [ "secret", "AvocadoDB is a database", "MD5", "6eecfc947725974efc24bbaaafe15a13" ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testPbkdf2 : function () {
      var data = [
        ...
        [ 'secret', 'avocadodb', 10, 16, undefined, 'cd55a9a823ba8a788060c2353440092f' ],
        [ 'secret', 'Avocadodb', 10, 16, undefined, '9af0cdc4ab37b4a17120f9796941046d' ],
        [ 'secret', 'Avocadodb', 10, 32, undefined, '9af0cdc4ab37b4a17120f9796941046d34c5260035189c297df5c07f9f7748a6' ],
        [ 'secret', 'Avocadodb', 100, 16, undefined, 'e9afe4e0f3d6fb5dddbe98046be214f7' ],
        [ 'secret', 'AvocadoDB is a database', 10, 16, undefined, '9a6a9c9f7bc553f9ee41e95f22a9600f' ],
        [ 'SECRET', 'AvocadoDB is a database', 10, 16, undefined, '9a56ce2d622a09678bcc7fbb1f01d47c' ],
        [ 'secret', 'AvocadoDB is a database', 10, 16, 'sha224', 'eb22c5bd06658b6c1b3e592c67d4264a' ],
        [ 'secret', 'AvocadoDB is a database', 10, 16, 'sha256', '4af8fad53d19ac984c0d1a8c128d5391' ],
        [ 'secret', 'AvocadoDB is a database', 10, 16, 'sha384', '9684202a2d1c1ed248724d248c866f11' ],
        [ 'secret', 'AvocadoDB is a database', 10, 16, 'sha512', '5818089d14f7366e0656ec851d55a140' ],
        [ 'secret', 'AvocadoDB is a database', 10, 16, 'md5', 'b4a63e5a9c02d76cb40aa37fd34c0a4f' ]
      ];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testJwt : function () {
      var data = [
        ...
        [ "secret", "avocadodb", "hs256", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.ImFyYW5nb2RiIg.pyWsjffR5WfVkRxtckXKwh-emE2kmKH0ZJRCCllqIYc" ],
        [ "secret", "Avocadodb", "hs256", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.IkFyYW5nb2RiIg.BjQqhHpWiGqi2RBeAjV1V0gkUBPNZHtKCu5rgeu9eno" ],
