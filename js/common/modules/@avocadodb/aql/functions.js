...
var validateName = function (name) {
  ...
  if (typeof name !== 'string' ||
    ...
    name.substr(0, 1) === '_') {
    var err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_QUERY_FUNCTION_INVALID_NAME.code;
    err.errorMessage = avocadodb.errors.ERROR_QUERY_FUNCTION_INVALID_NAME.message;
...
var stringifyFunction = function (code, name) {
  ...
  var err = new AvocadoError();
  err.errorNum = avocadodb.errors.ERROR_QUERY_FUNCTION_INVALID_CODE.code;
  err.errorMessage = avocadodb.errors.ERROR_QUERY_FUNCTION_INVALID_CODE.message;
...
var unregisterFunction = function (name) {
  ...
  if (func === null) {
    var err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_QUERY_FUNCTION_NOT_FOUND.code;
    err.errorMessage = internal.sprintf(avocadodb.errors.ERROR_QUERY_FUNCTION_NOT_FOUND.message, name);
