...
var sprintf = avocadodb.sprintf;
var db = avocadodb.db;

var simple = require('@avocadodb/simple-query');
...
AvocadoCollection.STATUS_LOADING = 6;

// //////////////////////////////////////////////////////////////////////////////
// / @brief document collection
// //////////////////////////////////////////////////////////////////////////////

AvocadoCollection.TYPE_DOCUMENT = 2;

// //////////////////////////////////////////////////////////////////////////////
// / @brief edge collection
// //////////////////////////////////////////////////////////////////////////////

AvocadoCollection.TYPE_EDGE = 3;

AvocadoCollection.prototype.isAvocadoCollection = true;

// //////////////////////////////////////////////////////////////////////////////
// / @brief prints a collection
// //////////////////////////////////////////////////////////////////////////////

AvocadoCollection.prototype._PRINT = function (context) {
  var status = 'unknown';
  var type = 'unknown';
  var name = this.name();

  switch (this.status()) {
    case AvocadoCollection.STATUS_NEW_BORN:
      status = 'new born';
      break;
    case AvocadoCollection.STATUS_UNLOADED:
      status = 'unloaded';
      break;
    case AvocadoCollection.STATUS_UNLOADING:
      status = 'unloading';
      break;
    case AvocadoCollection.STATUS_LOADED:
      status = 'loaded';
      break;
    case AvocadoCollection.STATUS_CORRUPTED:
      status = 'corrupted';
      break;
    case AvocadoCollection.STATUS_DELETED:
      status = 'deleted';
      break;
  }

  switch (this.type()) {
    case AvocadoCollection.TYPE_DOCUMENT:
      type = 'document';
      break;
    case AvocadoCollection.TYPE_EDGE:
      type = 'edge';
      break;
  }
  ...
  context.output += '[AvocadoCollection ';
...
AvocadoCollection.prototype.range = function (name, left, right) {
...
AvocadoCollection.prototype.closedRange = function (name, left, right) {
...
AvocadoCollection.prototype.geo = function (loc, order) {
  ...
  if (idx === null) {
    ...
    err.errorNum = avocadodb.errors.ERROR_QUERY_GEO_INDEX_MISSING.code;
    err.errorMessage = require('internal').sprintf(avocadodb.errors.ERROR_QUERY_GEO_INDEX_MISSING.message, this.name());
    throw err;
  }
...
AvocadoCollection.prototype.withinRectangle = function (lat1, lon1, lat2, lon2) {
  return new SimpleQueryWithinRectangle(this, lat1, lon1, lat2, lon2);
};

AvocadoCollection.prototype.fulltext = function (attribute, query, iid) {
...
AvocadoCollection.prototype.iterate = function (iterator, options) {
  var probability = 1.0;
  var limit = null;
  var stmt;
  var cursor;
  ...
  if (limit === null) {
    ...
    if (typeof limit !== 'number') {
      var error = new AvocadoError();
      error.errorNum = avocadodb.errors.ERROR_ILLEGAL_NUMBER.code;
...
AvocadoCollection.prototype.removeByExample = function (example, waitForSync, limit) {
...
AvocadoCollection.prototype.replaceByExample = function (example, newValue, waitForSync, limit) {
...
AvocadoCollection.prototype.updateByExample = function (example, newValue, keepNull, waitForSync, limit) {
...
AvocadoCollection.prototype.ensureHashIndex = function () {
  'use strict';
...
AvocadoCollection.prototype.ensureUniqueConstraint = function () {
  'use strict';
...
AvocadoCollection.prototype.ensureUniqueSkiplist = function () {
  'use strict';
...
AvocadoCollection.prototype.ensureSkiplist = function () {
  'use strict';
...
AvocadoCollection.prototype.ensureFulltextIndex = function (field, minLength) {
  'use strict';
...
// / since AvocadoDB 2.5, this is just a redirection to ensureGeoIndex
// //////////////////////////////////////////////////////////////////////////////

AvocadoCollection.prototype.ensureGeoConstraint = function (lat, lon) {
...
AvocadoCollection.prototype.ensureVertexCentricIndex = function (...fields) {
