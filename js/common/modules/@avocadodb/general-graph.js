...
const AvocadoCollection = avocadodb.AvocadoCollection;
...
var findOrCreateCollectionByName = function (name, type, noCreate, options) {
  ...
  if (col === null && !noCreate) {
    if (type === AvocadoCollection.TYPE_DOCUMENT) {
      if (options) {
...
var findOrCreateCollectionsByEdgeDefinitions = function (edgeDefinitions, noCreate, options) {
  ...
  edgeDefinitions.forEach(function (e) {
    if (!e.hasOwnProperty('collection') ||
      ...
      !Array.isArray(e.to)) {
      var err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_CREATE_MALFORMED_EDGE_DEFINITION.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_CREATE_MALFORMED_EDGE_DEFINITION.message;
      throw err;
    }

    e.from.forEach(function (v) {
      findOrCreateCollectionByName(v, AvocadoCollection.TYPE_DOCUMENT, noCreate, options);
    ...
    findOrCreateCollectionByName(e.collection, AvocadoCollection.TYPE_EDGE, noCreate, options);
...
var getGraphCollection = function () {
  ...
  if (gCol === null || gCol === undefined) {
    var err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_NO_GRAPH_COLLECTION.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_NO_GRAPH_COLLECTION.message;
    throw err;
  }
  return gCol;
};
...
// //////////////////////////////////////////////////////////////////////////////
// / @brief internal function to wrap avocado collections for overwrite
// //////////////////////////////////////////////////////////////////////////////
        ...
        function (edgeDefinition) {
          if (edgeDefinition.collection === key) {
            ...
            if (!_.includes(edgeDefinition.from, fromCollection) ||
              ...
              var err = new AvocadoError();
              err.errorNum = avocadodb.errors.ERROR_GRAPH_INVALID_EDGE.code;
              err.errorMessage =
                avocadodb.errors.ERROR_GRAPH_INVALID_EDGE.message +
...
var checkRWPermission = function (c) {
  ...
  if (user) {
    ...
    if (p !== 'rw') {
      ...
      var err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_FORBIDDEN.code;
      err.errorMessage = avocadodb.errors.ERROR_FORBIDDEN.message;
      throw err;
    }
  }
};
...
class Graph {
  constructor (info) {
    ...
    var useBuiltIn = (typeof AvocadoClusterComm === 'object');
    if (useBuiltIn && require('@avocadodb/cluster').isCoordinator()) {
      useBuiltIn = false;
    }
...
// //////////////////////////////////////////////////////////////////////////////
  ...
  _EDGES (vertexId) {
    if (vertexId.indexOf('/') === -1) {
      ...
      err.errorNum = avocadodb.errors.ERROR_GRAPH_NOT_FOUND.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_NOT_FOUND.message + ': ' + vertexId;
      throw err;
    }
...
// //////////////////////////////////////////////////////////////////////////////
  ...
  _getEdgeCollectionByName (name) {
    ...
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_EDGE_COL_DOES_NOT_EXIST.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_EDGE_COL_DOES_NOT_EXIST.message + ': ' + name;
    throw err;
  }
...
// //////////////////////////////////////////////////////////////////////////////
  ...
  _getVertexCollectionByName (name) {
    ...
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST.message + ': ' + name;
    throw err;
  }
...
// //////////////////////////////////////////////////////////////////////////////
  ...
  _extendEdgeDefinitions (edgeDefinition) {
    ...
    if (this.__edgeCollections[eC] !== undefined) {
      ...
      err.errorNum = avocadodb.errors.ERROR_GRAPH_COLLECTION_MULTI_USE.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_COLLECTION_MULTI_USE.message;
      throw err;
    }
    // in different graph
          ...
          function (sGED) {
            ...
            if (col === eC) {
              if (JSON.stringify(sGED) !== JSON.stringify(edgeDefinition)) {
                err = new AvocadoError();
                err.errorNum = avocadodb.errors.ERROR_GRAPH_COLLECTION_USE_IN_MULTI_GRAPHS.code;
                err.errorMessage = col + ' ' +
                                   avocadodb.errors.ERROR_GRAPH_COLLECTION_USE_IN_MULTI_GRAPHS.message;
                throw err;
              }
            }
          }
...
// //////////////////////////////////////////////////////////////////////////////
  ...
  _editEdgeDefinitions (edgeDefinition) {
    ...
    if (this.__edgeCollections[edgeDefinition.collection] === undefined) {
      var err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_EDGE_COLLECTION_NOT_USED.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_EDGE_COLLECTION_NOT_USED.message;
      throw err;
    }
  ...
  _addVertexCollection (vertexCollectionName, createCollection) {
    ...
    if (ec === null) {
      if (createCollection !== false) {
        ...
        err = new AvocadoError();
        err.errorNum = avocadodb.errors.ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST.code;
        err.errorMessage = vertexCollectionName + avocadodb.errors.ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST.message;
        throw err;
      }
    } else if (ec.type() !== 2) {
      err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_WRONG_COLLECTION_TYPE_VERTEX.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_WRONG_COLLECTION_TYPE_VERTEX.message;
      throw err;
    }
    if (this.__vertexCollections[vertexCollectionName] !== undefined) {
      err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_COLLECTION_USED_IN_EDGE_DEF.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_COLLECTION_USED_IN_EDGE_DEF.message;
      throw err;
    }
    if (_.includes(this.__orphanCollections, vertexCollectionName)) {
      err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_COLLECTION_USED_IN_ORPHANS.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_COLLECTION_USED_IN_ORPHANS.message;
      throw err;
    }
...
// //////////////////////////////////////////////////////////////////////////////
  ...
  _removeVertexCollection (vertexCollectionName, dropCollection) {
    ...
    if (db._collection(vertexCollectionName) === null) {
      err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST.message;
      throw err;
    }
    ...
    if (index === -1) {
      err = new AvocadoError();
      err.errorNum = avocadodb.errors.ERROR_GRAPH_NOT_IN_ORPHAN_COLLECTION.code;
      err.errorMessage = avocadodb.errors.ERROR_GRAPH_NOT_IN_ORPHAN_COLLECTION.message;
      throw err;
    }
...
exports._relation = function (relationName, fromVertexCollections, toVertexCollections) {
  if (arguments.length < 3) {
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_INVALID_NUMBER_OF_ARGUMENTS.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_INVALID_NUMBER_OF_ARGUMENTS.message + '3';
    throw err;
  }

  if (typeof relationName !== 'string' || relationName === '') {
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_INVALID_PARAMETER.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_INVALID_PARAMETER.message + ' arg1 must be non empty string';
    throw err;
  }
  ...
  if (!isValidCollectionsParameter(fromVertexCollections)) {
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_INVALID_PARAMETER.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_INVALID_PARAMETER.message +
...
exports._graph = function (graphName) {
  ...
  try {
    ...
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_NOT_FOUND.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_NOT_FOUND.message;
    throw err;
  }
  if (g.isSmart) {
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_INVALID_GRAPH.code;
...
exports._create = function (graphName, edgeDefinitions, orphanCollections, options) {
  ...
  if (!graphName) {
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_CREATE_MISSING_NAME.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_CREATE_MISSING_NAME.message;
    throw err;
  }
  ...
  if (graphAlreadyExists) {
    let err = new AvocadoError();
    err.errorNum = avocadodb.errors.ERROR_GRAPH_DUPLICATE.code;
    err.errorMessage = avocadodb.errors.ERROR_GRAPH_DUPLICATE.message;
    throw err;
  }
  ...
  orphanCollections.forEach(
    (oC, options) => {
      findOrCreateCollectionByName(oC, AvocadoCollection.TYPE_DOCUMENT, false, options);
    }
  );
...
exports._registerCompatibilityFunctions = function () {
  const aqlfunctions = require('@avocadodb/aql/functions');
  aqlfunctions.register('avocadodb::GRAPH_EDGES', function (graphName, vertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._edges(vertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_VERTICES', function (graphName, vertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._vertices(vertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_NEIGHBORS', function (graphName, vertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._neighbors(vertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_COMMON_NEIGHBORS', function (graphName, vertex1Example, vertex2Example, options1, options2) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._commonNeighbors(vertex1Example, vertex2Example, options1, options2);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_COMMON_PROPERTIES', function (graphName, vertex1Example, vertex2Example, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._commonProperties(vertex1Example, vertex2Example, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_PATHS', function (graphName, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._paths(options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_SHORTEST_PATH', function (graphName, startVertexExample, edgeVertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._shortestPath(startVertexExample, edgeVertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_DISTANCE_TO', function (graphName, startVertexExample, edgeVertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._distanceTo(startVertexExample, edgeVertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_ABSOLUTE_ECCENTRICITY', function (graphName, vertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._absoluteEccentricity(vertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_ECCENTRICITY', function (graphName, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._eccentricity(options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_ABSOLUTE_CLOSENESS', function (graphName, vertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._farness(vertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_CLOSENESS', function (graphName, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._closeness(options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_ABSOLUTE_BETWEENNESS', function (graphName, vertexExample, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._absoluteBetweenness(vertexExample, options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_BETWEENNESS', function (graphName, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._betweenness(options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_RADIUS', function (graphName, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
    return g._radius(options);
  }, false);
  aqlfunctions.register('avocadodb::GRAPH_DIAMETER', function (graphName, options) {
    var gm = require('@avocadodb/general-graph');
    var g = gm._graph(graphName);
