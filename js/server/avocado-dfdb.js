////////////////////////////////////////////////////////////////////////////////
/// @brief avocado datafile debugger
///
/// @file
///
/// DISCLAIMER
...
function QueryWipeDatafile (collection, type, datafile, scan, lastGoodPos) {
  ...
  if (type === "journal") {
    if (entries.length === lastGoodPos + 3 && entries[lastGoodPos + 2].status === 2) {
      ...
      printf("         This might happen if AvocadoDB was killed and the last entry was not\n");
      ...
      printf("         This might happen if AvocadoDB was killed and the last entries were not\n");
