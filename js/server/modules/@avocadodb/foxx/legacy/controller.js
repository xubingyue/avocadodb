...
const RequestContext = require('@avocadodb/foxx/legacy/request_context');
const BaseMiddleware = require('@avocadodb/foxx/legacy/base_middleware').BaseMiddleware;
const is = require('@avocadodb/is');
const internal = require('@avocadodb/foxx/legacy/internals');
const swagger = require('@avocadodb/foxx/legacy/swagger');
...
var authControllerProps = {
  ...
  // //////////////////////////////////////////////////////////////////////////////
  getUsers() {
    const foxxAuthentication = require('@avocadodb/foxx/legacy/authentication');
  ...
  // //////////////////////////////////////////////////////////////////////////////
  login(route, opts) {
    var authentication = require('@avocadodb/foxx/legacy/authentication');
...
var sessionControllerProps = {
  ...
  destroySession(route, opts) {
    ...
    var sessions = require('@avocadodb/foxx/legacy/sessions');
...
class Controller {
  ...
  handleRequest (method, route, callback) {
    ...
    if (method === 'post' || method === 'put' || method === 'patch') {
      const Model = require('@avocadodb/foxx/legacy').Model;
