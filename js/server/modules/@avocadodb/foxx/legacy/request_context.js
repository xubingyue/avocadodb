...
const SwaggerDocs = require('@avocadodb/foxx/legacy/swaggerDocs').Docs;
const joi = require('joi');
const _ = require('lodash');
const internal = require('@avocadodb/foxx/legacy/internals');
const toJSONSchema = require('@avocadodb/foxx/legacy/schema').toJSONSchema;
const is = require('@avocadodb/is');
const UnprocessableEntity = require('http-errors').UnprocessableEntity;
const UnauthorizedError = require('@avocadodb/foxx/legacy/authentication').UnauthorizedError;
