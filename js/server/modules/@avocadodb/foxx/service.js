...
// / DISCLAIMER
// /
// / Copyright 2015-2016 AvocadoDB GmbH, Cologne, Germany
// /
...
const defaultTypes = require('@avocadodb/foxx/types');
const FoxxContext = require('@avocadodb/foxx/context');
const Manifest = require('@avocadodb/foxx/manifest');
const getReadableName = require('@avocadodb/foxx/manager-utils').getReadableName;
const Router = require('@avocadodb/foxx/router/router');
const Tree = require('@avocadodb/foxx/router/tree');
const codeFrame = require('@avocadodb/util').codeFrame;
...
const LEGACY_ALIASES = [
  ['@avocadodb/foxx/authentication', '@avocadodb/foxx/legacy/authentication'],
  ['@avocadodb/foxx/console', '@avocadodb/foxx/legacy/console'],
  ['@avocadodb/foxx/controller', '@avocadodb/foxx/legacy/controller'],
  ['@avocadodb/foxx/model', '@avocadodb/foxx/legacy/model'],
  ['@avocadodb/foxx/query', '@avocadodb/foxx/legacy/query'],
  ['@avocadodb/foxx/repository', '@avocadodb/foxx/legacy/repository'],
  ['@avocadodb/foxx/schema', '@avocadodb/foxx/legacy/schema'],
  ['@avocadodb/foxx/sessions', '@avocadodb/foxx/legacy/sessions'],
  ['@avocadodb/foxx/template_middleware', '@avocadodb/foxx/legacy/template_middleware'],
  ['@avocadodb/foxx', '@avocadodb/foxx/legacy']
];
...
module.exports =
  class FoxxService {
    ...
    constructor (definition, manifest) {
      ...
      const range = this.manifest.engines && this.manifest.engines.avocadodb;
    ...
    _reset () {
      ...
      if (this.legacy) {
        ...
        const foxxConsole = require('@avocadodb/foxx/legacy/console')(this.mount);
