/*jshint strict: false */
/*global AvocadoClusterInfo, AvocadoClusterComm, require, exports, module */
...
var AvocadoDatabase = require('@avocadodb/avocado-database').AvocadoDatabase;

      
AvocadoCollection.prototype.shards = function () {
  return Object.keys(AvocadoClusterInfo.getCollectionInfo(require('internal').db._name(), this.name()).shardShorts);
};
...
AvocadoCollection.prototype.truncate = function () {
  var cluster = require('@avocadodb/cluster');
  if (cluster.isCoordinator()) {
    if (this.status() === AvocadoCollection.STATUS_UNLOADED) {
      this.load();
    }
  }
...
// /
// / @code
// / avocado> db.example.getIndexes().map(function(x) { return x.id; })
// / ["example/0"]
// / avocado> db.example.index("93013/0")
...
AvocadoCollection.prototype.any = function () {
  ...
  if (cluster.isCoordinator()) {
    ...
    var coord = { coordTransactionID: AvocadoClusterComm.getId() };
    var options = { coordTransactionID: coord.coordTransactionID, timeout: 360 };

    shards.forEach(function (shard) {
      AvocadoClusterComm.asyncRequest('put',
        'shard:' + shard,
        dbName,
        '/_api/simple/any',
        JSON.stringify({
...
AvocadoCollection.prototype.lookupUniqueConstraint = function () {
  'use strict';
...
AvocadoCollection.prototype.lookupHashIndex = function () {
  'use strict';
...
AvocadoCollection.prototype.lookupUniqueSkiplist = function () {
  'use strict';
...
AvocadoCollection.prototype.lookupSkiplist = function () {
  'use strict';
...
AvocadoCollection.prototype.lookupFulltextIndex = function (field, minLength) {
  'use strict';
