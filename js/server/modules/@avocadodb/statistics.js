...
exports.historian = function () {
  ...
  var clusterId = cluster.isCluster() && global.AvocadoServerState.id();
  ...
  try {
    ...
    if (err.errorNum !== internal.errors.ERROR_SHUTTING_DOWN.code &&
        err.errorNum !== internal.errors.ERROR_AVOCADO_CORRUPTED_COLLECTION.code &&
        err.errorNum !== internal.errors.ERROR_AVOCADO_CORRUPTED_DATAFILE.code) {
...
exports.installPeriodicTasks = function () {
  ...
  internal.registerTask({
    ...
    offset: interval / 10,
    period: interval,
    command: "require('@avocadodb/statistics').historian();"
  });
  ...
  internal.registerTask({
    ...
    offset: 2 * interval,
    period: interval15,
    command: "require('@avocadodb/statistics').historianAverage();"
  });
  ...
  internal.registerTask({
    ...
    period: interval15 / 2,
    command: "require('@avocadodb/statistics').garbageCollector();"
  });
};
...
exports.startup = function () {
  internal.registerTask({
    ...
    offset: 10,
    command: "require('@avocadodb/statistics').installPeriodicTasks();"
  });
};
