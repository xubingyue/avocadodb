...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRenameCollection1 : function () {
      ...
      try {
        ...
        assertEqual(internal.errors.ERROR_AVOCADO_COLLECTION_NOT_FOUND.code, err.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testOtherError : function () {
      ...
      try {
        ...
        assertEqual(internal.errors.ERROR_AVOCADO_COLLECTION_NOT_FOUND.code, err1.errorNum);
      }
      ...
      try {
        ...
        assertEqual(internal.errors.ERROR_AVOCADO_COLLECTION_NOT_FOUND.code, err2.errorNum);
      }
    },
