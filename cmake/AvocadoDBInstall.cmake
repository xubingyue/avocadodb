...
if (UNIX)
  ...
  if (SYSTEMD_FOUND)
    ...
    configure_file (
      ${ARANGODB_SOURCE_DIR}/Installation/systemd/avocadodb3.service.in
    ...
    configure_file (
      ${ARANGODB_SOURCE_DIR}/Installation/logrotate.d/avocadod.systemd
    ...
    configure_file (
      ${ARANGODB_SOURCE_DIR}/Installation/logrotate.d/avocadod.sysv
