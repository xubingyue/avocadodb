...
set(AVOCADODB_SOURCE_DIR ${CMAKE_SOURCE_DIR})
set(CMAKE_INSTALL_SYSCONFDIR_AVOCADO "${CMAKE_INSTALL_SYSCONFDIR}/${CMAKE_PROJECT_NAME}")
set(CMAKE_INSTALL_FULL_SYSCONFDIR_AVOCADO "${CMAKE_INSTALL_FULL_SYSCONFDIR}/${CMAKE_PROJECT_NAME}")

set(CMAKE_INSTALL_DATAROOTDIR_AVOCADO "${CMAKE_INSTALL_DATAROOTDIR}/${CMAKE_PROJECT_NAME}")
set(CMAKE_INSTALL_FULL_DATAROOTDIR_AVOCADO "${CMAKE_INSTALL_FULL_DATAROOTDIR}/${CMAKE_PROJECT_NAME}")
...
# database directory
set(AVOCADODB_DB_DIRECTORY "${PROJECT_BINARY_DIR}/var/lib/${CMAKE_PROJECT_NAME}")
FILE(MAKE_DIRECTORY ${AVOCADODB_DB_DIRECTORY})

# apps
set(AVOCADODB_APPS_DIRECTORY "/var/lib/${CMAKE_PROJECT_NAME}-apps")
set(AVOCADODB_FULL_APPS_DIRECTORY "${PROJECT_BINARY_DIR}${AVOCADODB_APPS_DIRECTORY}")
FILE(MAKE_DIRECTORY "${AVOCADODB_FULL_APPS_DIRECTORY}")
...
add_custom_target (love
  COMMENT "AvocadoDB loves you."
  COMMAND ""
  )

include(InstallAvocadoDBJSClient)
...
install(
  DIRECTORY
    ${PROJECT_BINARY_DIR}/var/log/avocadodb3
  DESTINATION
...
if (UNIX)
  if (${USE_ENTERPRISE})
    set(SERVICE_NAME "avocadodb3e")
  else ()
    set(SERVICE_NAME "avocadodb3")
  endif ()
  ...
  if (SYSTEMD_FOUND)
    ...
    configure_file (
      ${AVOCADODB_SOURCE_DIR}/Installation/logrotate.d/avocadod.sysv
      ${PROJECT_BINARY_DIR}/avocadod.sysv
      NEWLINE_STYLE UNIX)
  endif()
endif()
################################################################################
...
to_native_path("CMAKE_INSTALL_FULL_SYSCONFDIR_AVOCADO")
