...
file(TO_NATIVE_PATH "resources/avocadodb.ico" RELATIVE_AVOCADO_ICON)
file(TO_NATIVE_PATH "${ICON_PATH}avocadodb.bmp" AVOCADO_IMG)
file(TO_NATIVE_PATH "${ICON_PATH}/avocadodb.ico" AVOCADO_ICON)
file(TO_NATIVE_PATH "${ICON_PATH}/avocadodb_big.bmp" AVOCADO_BIG_ICON)
file(TO_NATIVE_PATH "${ICON_PATH}/avocadodb_welcomefinish.bmp" AVOCADO_GRAPH_ICON)
...
STRING(REGEX REPLACE "\\\\" "\\\\\\\\" AVOCADO_BIG_ICON "${AVOCADO_BIG_ICON}")
STRING(REGEX REPLACE "\\\\" "\\\\\\\\" AVOCADO_GRAPH_ICON "${AVOCADO_GRAPH_ICON}")
...
set(CPACK_NSIS_HEADER_ICON         ${AVOCADO_BIG_ICON})
set(CPACK_NSIS_PAGE_ICON           ${AVOCADO_GRAPH_ICON})
set(CPACK_NSIS_INSTALLER_ICON_CODE ${AVOCADO_BIG_ICON})
...
set(AVOCADODB_CLIENT_PACKAGE_FILE_NAME "${CPACK_CLIENT_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${AVOCADODB_PACKAGE_REVISION}_${AVOCADODB_PACKAGE_ARCHITECTURE}")
...
add_custom_target(package-arongodb-client-nsis
  ...
  COMMAND ${CMAKE_COMMAND} -E copy ${CLIENT_BUILD_DIR}/${AVOCADODB_CLIENT_PACKAGE_FILE_NAME}.exe ${PROJECT_BINARY_DIR}
...
add_custom_target(copy_client_nsis_package
  COMMAND ${CMAKE_COMMAND} -E copy ${AVOCADODB_CLIENT_PACKAGE_FILE_NAME}.exe ${PACKAGE_TARGET_DIR})
...
add_custom_target(remove_packages
  ...
  COMMAND ${CMAKE_COMMAND} -E remove ${AVOCADODB_CLIENT_PACKAGE_FILE_NAME}.exe
