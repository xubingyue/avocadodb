...
#  set(SNAP_PORT 8529)
  ...
  add_custom_target(snap
    ...
    COMMAND ${CMAKE_COMMAND} -E copy ${SNAPCRAFT_SOURCE_DIR}/${CPACK_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}*_${AVOCADODB_PACKAGE_ARCHITECTURE}.snap ${PROJECT_BINARY_DIR}
    DEPENDS TGZ_package
    WORKING_DIRECTORY ${SNAPCRAFT_SOURCE_DIR}
  )

  add_custom_target(copy_snap_packages
    COMMAND ${CMAKE_COMMAND} -E copy ${CPACK_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}*_${AVOCADODB_PACKAGE_ARCHITECTURE}.snap ${PACKAGE_TARGET_DIR})
