...
set(AVOCADODB_DBG_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-dbg-${CPACK_PACKAGE_VERSION}-${AVOCADODB_PACKAGE_REVISION}_${AVOCADODB_PACKAGE_ARCHITECTURE}")
...
add_custom_target(package-arongodb-client
  ...
  COMMAND ${CMAKE_COMMAND} -E copy ${CLIENT_BUILD_DIR}/${AVOCADODB_CLIENT_PACKAGE_FILE_NAME}.deb ${PROJECT_BINARY_DIR}
...
add_custom_target(copy_deb_packages
  COMMAND ${CMAKE_COMMAND} -E copy ${AVOCADODB_CLIENT_PACKAGE_FILE_NAME}.deb ${PACKAGE_TARGET_DIR}
  COMMAND ${CMAKE_COMMAND} -E copy ${CPACK_PACKAGE_FILE_NAME}.deb           ${PACKAGE_TARGET_DIR}
  COMMAND ${CMAKE_COMMAND} -E copy ${AVOCADODB_DBG_PACKAGE_FILE_NAME}.deb    ${PACKAGE_TARGET_DIR}
...
add_custom_target(remove_packages
  ...
  COMMAND ${CMAKE_COMMAND} -E remove ${AVOCADODB_CLIENT_PACKAGE_FILE_NAME}.deb
  COMMAND ${CMAKE_COMMAND} -E remove ${CPACK_PACKAGE_FILE_NAME}.deb
  COMMAND ${CMAKE_COMMAND} -E remove ${AVOCADODB_DBG_PACKAGE_FILE_NAME}.deb
...
add_custom_target(package-arongodb-dbg
  ...
  COMMAND ${CMAKE_CPACK_COMMAND} -G DEB
  COMMAND ${CMAKE_COMMAND} -E copy ${AVOCADODB_DBG_PACKAGE_FILE_NAME}.deb ${PROJECT_BINARY_DIR}
