...
#ifndef AVOCADODB_BENCHMARK_BENCHMARK_OPERATION_H
#define AVOCADODB_BENCHMARK_BENCHMARK_OPERATION_H 1
...
struct BenchmarkOperation {
  ...
  virtual bool setUp(avocadodb::httpclient::SimpleHttpClient*) = 0;
  ...
  virtual avocadodb::rest::RequestType type(int const, size_t const,
                                                     size_t const) = 0;
