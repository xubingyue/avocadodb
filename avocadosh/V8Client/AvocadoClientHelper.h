...
#ifndef AVOCADODB_V8CLIENT_AVOCADO_CLIENT_HELPER_H
#define AVOCADODB_V8CLIENT_AVOCADO_CLIENT_HELPER_H 1
...
class AvocadoClientHelper {
 ...
 public:
  ...
  bool getAvocadoIsCluster(int* err);
