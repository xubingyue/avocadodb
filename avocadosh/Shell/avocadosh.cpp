...
int main(int argc, char* argv[]) {
  return ClientFeature::runMain(argc, argv, [&](int argc, char* argv[]) -> int {
    ...
    try {
      ...
      LOG_TOPIC(ERR, avocadodb::Logger::FIXME) << "avocadosh terminated because of an unhandled exception: "
              << ex.what();
      ret = EXIT_FAILURE;
    } catch (...) {
      LOG_TOPIC(ERR, avocadodb::Logger::FIXME) << "avocadosh terminated because of an unhandled exception of "
                  "unknown type";
      ret = EXIT_FAILURE;
    }
