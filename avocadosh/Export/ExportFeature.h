...
class ExportFeature final : public application_features::ApplicationFeature,
 ...
 private:
  ...
  std::shared_ptr<VPackBuilder> httpCall(httpclient::SimpleHttpClient* httpClient, std::string const& url, avocadodb::rest::RequestType, std::string postBody = "");
