...
################################################################################
    ...
    context "remove-by-example query:" do
      before do
        ...
        (0...20).each{|i|
          AvocadoDB.post("/_api/document?collection=#{@cn}", :body => "{ \"value\" : #{i}, \"value2\" : 99 }")
        }
      end
      ...
      it "removes the examples" do
        ...
        (0...10).each{|i|
          AvocadoDB.post("/_api/document?collection=#{@cn}", :body => "{ \"value99\" : 7, \"value98\" : 1 }")
        }
      ...
      it "removes the examples, with limit" do
        ...
        doc = AvocadoDB.log_put("#{prefix}-remove-by-example-limit", cmd, :body => body)
...
################################################################################
    ...
    context "replace-by-example query:" do
      ...
      it "replaces the examples" do
        ...
        doc = AvocadoDB.log_put("#{prefix}-replace-by-example", cmd, :body => body)
      ...
      it "replaces the examples, with limit" do
        ...
        doc = AvocadoDB.log_put("#{prefix}-replace-by-example-limit", cmd, :body => body)
...
################################################################################
    ...
    context "update-by-example query:" do
      ...
      it "updates the examples" do
        ...
        body = "{ \"collection\" : \"#{@cn}\", \"example\" : { \"value\" : 1 }, \"newValue\" : { \"foo\" : \"bar\" } }"
        doc = AvocadoDB.log_put("#{prefix}-update-by-example", cmd, :body => body)
      ...
      it "updates the examples, with limit" do
        ...
        doc = AvocadoDB.log_put("#{prefix}-update-by-example-limit", cmd, :body => body)
...
################################################################################
    ...
    context "update-by-example query, mergeObjects:" do
      before do
        ...
        AvocadoDB.post("/_api/document?collection=#{@cn}", :body => "{ \"_key\" : \"one\", \"value\" : \"test\" }")
        AvocadoDB.post("/_api/document?collection=#{@cn}", :body => "{ \"_key\" : \"two\", \"value\" : { \"test\" : \"foo\" } }")
      end
      ...
      it "updates the example, empty update value" do
        ...
        doc = AvocadoDB.log_get("#{prefix}-update-by-example", "/_api/document/#{@cn}/two", :body => "")
      ...
      it "updates the example, mergeObjects not specified" do
        ...
        doc = AvocadoDB.log_get("#{prefix}-update-by-example", "/_api/document/#{@cn}/one", :body => "")
