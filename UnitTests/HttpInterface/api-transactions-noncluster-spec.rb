...
################################################################################
    ...
    context "using wrong collections:" do
      ...
      it "returns an error when using a non-declared collection" do
        ...
        doc = AvocadoDB.log_post("#{prefix}-non-declared-collection", cmd, :body => body)
      ...
      it "returns an error when using a collection in invalid mode" do
        ...
        doc = AvocadoDB.log_post("#{prefix}-invalid-mode1", cmd, :body => body)
...
################################################################################
    ...
    context "single collection transactions:" do
      ...
      it "aborting" do
        ...
        doc = AvocadoDB.log_post("#{prefix}-single-abort", cmd, :body => body)
...
################################################################################
    ...
    context "multi collection transactions:" do
      ...
      it "aborting" do
        ...
        doc = AvocadoDB.log_post("#{prefix}-multi-abort", cmd, :body => body)
        ...
        AvocadoDB.size_collection(@cn1).should eq(0);
        AvocadoDB.size_collection(@cn2).should eq(0);
      end
